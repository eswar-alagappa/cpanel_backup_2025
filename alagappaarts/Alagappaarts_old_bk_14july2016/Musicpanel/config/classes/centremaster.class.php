	...
	function centerStats()
		...
		function resetPassword($centreid,$loginid){
			...
			$from=ADMIN_EMAIL;
					...
					$subject = "Appa User Credentials";
					 $message = "We are happy to annouce that APAA launched new website with online exam facility.<br/><br/>
							...
							http://alagappaarts.com/music/center/<br/><br/>
					  ...
					  $header = "From: Customer support <".$from.">\r\n";
                                        // $header .= "Bcc: customersupport@alagappaarts.com,naresh@aiitech.com"."\r\n";
