...
messages:{
		...
		txthour :{required : "Enter Hour",digits:"Only Number" },
		txtmin : {required :"Enter minutes",digits:"Only Number" },
		txtlimit :{required : "Enter exam attempt limit",digits:"Only Number" },
