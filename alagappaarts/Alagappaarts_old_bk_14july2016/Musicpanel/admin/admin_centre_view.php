...
<div class="content">
    ...
    <div class="studentViewContent">
      ...
      <li><label>Email : 
		<?php echo $centredetail->fields[centreEmail_id]; ?>  </label> </li>
...
<li><label>Address:<?php  if( $centredetail->fields[address] )echo $centredetail->fields[address]; else echo '-'; ?></label></li>
        ...
        <li><label>State : <?php echo $centredetail->fields[5]; ?></label></li>
        <li><label>Country:  <?php echo $centredetail->fields[6]; ?></label></li>
        <li><label>Zip: <?php echo $centredetail->fields[7]; ?></label></li>
        <li>
...
<li><label>Address:  <?php if( $centredetail->fields[directorAdress] )echo $centredetail->fields[directorAdress]; else echo '-'; ?></label></li>
     ...
     <ul>
              <li>
                <label>Experience in Music :<?php if( $centredetail->fields[bharathanatyam_experience] )echo $centredetail->fields[bharathanatyam_experience]; else echo '-'; ?> </label></li>
                     <li>
      ...
      <ul> <li class="button"><a href="admin_centre_listing.php" class="backBtn">Back</a>        </li> </ul>
      </div>
