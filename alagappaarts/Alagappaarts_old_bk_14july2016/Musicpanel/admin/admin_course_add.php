      ...
      <li class="programlist">
       ...
       <fieldset class="w97p" id="examquestion">
		...
		?>
                ...
                <td valign="top" align="left">
                <input type="text" size="8" name="txtNoofQuestion[]" class="classNoofQuestion required number"  maxlength="2"  min="1" ></td>
...
<br />
		...
		<div class="durationyear"><span class="year">Hours </span><input type="text" class="w65 fL mR10" name="txthour" maxlength="3"  min="0" ></div>
        <div class="durationmonth"><span class="year">Mins   </span><input type="text" class="w65" name="txtmin" maxlength="3" min="0"></div> </li>
        <li>
        <label>Exam attempt limit    :<strong class="star">*</strong> </label>
		<input name="txtlimit" type="text" maxlength="3"  min="1" />  </li>
        <li>
