...
<div class="content">
  ...
  <tr>
  <td height="38" class="schfromdate"><input name="txtschfromdate" type="text" value=""  class="datepicker examfromDate required date" title="Enter from date"/> </td>
    <td height="38" class="schtodate"><input name="txtschtodate" type="text" value=""  class="datepicker examtoDate required date"  title="Enter to date"/> </td>
  </tr>
</table>
