...
if(isset($_REQUEST['btnLogin']))
{
		...
		$loginerror = $oUserMaster -> checkstudentlogin($arrlogindetails);
...
<div class="loginFormTitle">Student Login</div>
<div class="loginForm ">
<div class="loginFormRightBg">
<?php  if($loginerror) {echo "<span class='admininderror'>$loginerror</span>";} ?>
