...
define( "NOTIFY_URL", 'http://alagappaarts.com/userpanel/student/student_paymentconfirmation.php' );
define( "RETURN_URL", 'http://alagappaarts.com/userpanel/student/student_paymentconfirmation.php' );
define( "CANCEL_URL", 'http://alagappaarts.com/userpanel/student/student_paymentconfirmation.php' );

define("ADMIN_EMAIL",'customersupport@alagappaarts.com');
define("STUDENT_LOGIN_URL",'http://alagappaarts.com/userpanel/student/');
