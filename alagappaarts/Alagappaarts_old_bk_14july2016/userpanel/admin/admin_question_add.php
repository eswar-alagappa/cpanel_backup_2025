...
$(".dynamicfields>div:last-child").children().next().children().val("");
        ...
        <span class="title">Multiple Choice Question<strong class="star">*</strong></span>
          ...
          <ul>
            ...
            <div class="optans1"></div>
              ...
              <span class="correctAnswer"><input class="radiobtn" name="chkans[]" type="radio" value="0" /></span>
              </li>
            <li>
              ...
              <span class="correctAnswer"><input class="radiobtn" name="chkans[]" type="radio" value="1" /></span>
              </li>
            <li>
            <div class="optans3"></div>
              ...
              <span class="correctAnswer"><input class="radiobtn" name="chkans[]" type="radio" value="2" /></span>
              </li>
            <li>
            <div class="optans4"></div>
              ...
              <span class="correctAnswer"><input class="radiobtn" name="chkans[]" type="radio" value="3" /></span>
              </li>
          </ul>
        </div>
