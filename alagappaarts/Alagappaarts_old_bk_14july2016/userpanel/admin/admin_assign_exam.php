...
<select name="assignExam[0][ddlcourse]"  class="required course <?php if($studentexamassignedCourses){ echo ""; } else echo "required"; ?> " title="Select Course">  <option value="">Select</option>  
   <?php foreach ($studentCourses as $studentCourse) { echo "<option value='{$studentCourse[id]}'>{$studentCourse[code]}</option>"; }  ?>
                </select>
      
    </td>
    <td height="38" class="schfromdate"><input name="assignExam[0][txtschdate1]" type="text" value=""  class="required datepicker examfromDate  <?php if($studentexamassignedCourses){ echo ""; } else echo "required"; ?> date" title="Enter from date"/> </td>
    <td height="38" class="schtodate"><input name="assignExam[0][txtschdate2]" type="text" value=""  class="required datepicker examtoDate   <?php if($studentexamassignedCourses) { echo ""; } else echo "required"; ?> date"  title="Enter to date"/> </td>
