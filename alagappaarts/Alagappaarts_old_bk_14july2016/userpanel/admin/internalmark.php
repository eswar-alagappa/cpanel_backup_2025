...
echo "<div class='onlineExamContentTitle'>
 ...
 ";
  ...
  <?php  if($onemarkquestions){
	...
	$onemarkanswers = $exammaster -> getonemarkanswer($studentarray); //mark_per_qtn
	 if($onemarkanswers ){ 
...
echo ' <ul class="w800">
  ...
  <tr>';
    ...
    <input name='markforQuestion[{$onemarkanswer[id]}][mark]'    {$disabled}  value='{$onemarkanswer[mark]}' max='{$onemarkanswer[mark_per_qtn]}' maxlength='1' type='text' class='marks required number' id='fillUP".$j."' title='Enter mark'/>
    </td>
  </tr>
</table>
	</li>
...
<?php echo "
  ...
  <tr>
    ...
    <td valign='top' align='right'><input name='markforQuestion[{$subjectiveanswer[id]}][mark] ' value='{$subjectiveanswer[mark]}' max='$subjectiveanswer[marks_per_question]' maxlength='2' type='text' class='marks required number' id='part4mark1{$i}{$j}' title='Enter mark'/></td>
  </tr>
</table>
	</li>
    </ul>";
