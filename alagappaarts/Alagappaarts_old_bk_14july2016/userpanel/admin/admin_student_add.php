 ...
 $('#btnStudentadd').click(function(){
		 ...
		 if($('#studentForm').valid()==true){
			  ...
			  $('#btnStudentadd').attr("disabled", true);
				  ...
				  $('#btnStudentadd').attr("disabled", false);
				 }
		 });
    ...
    <div class="registrationContent">
      ...
      <li><label>D.O.B:</label>
       ...
       <li><label> Age :<strong class="star">*</strong></label>
		<input name="txtAge" id="txtAge" type="text" readonly="readonly" maxlength="3" />  </li>
...
<input type="text" id="txtEnrollmentid" class="txtEnrollmentid" name="txtEnrollmentid" value="">
<span id="msg"></span> </li></ul>
        </fieldset>
      </div>
      <ul><li class="button"><input id="btnStudentadd" name="btnStudentadd" value="submit" type="button" class="submitBtn" />
