...
$subtotal = $exammaster -> getmarksubtotal($markdetail); ?>
		<span><input name="" type="text" id="partone" disabled="disabled" value="<?php echo $subtotal;?>"/></span>
         </li>
          </fieldset>
      </ul>
      <?php }?>
...
$onemarkanswers = $exammaster -> getonemarkanswer($studentarray); //print_r($onemarkquestion );exit;
//echo "<pre>";
...
if($matchanswers ){
    ...
    <fieldset class="slideUp">
        <legend> <?php
		  ...
		  echo "Part {$onemarkquestion[partition]} {$onemarkquestion[name]}" ; ?>  </legend>
        <div class="menu_body">
...
<ul class="w800">
  ...
  <tr>
    ...
    <input name="<?php echo "markforQuestion[{$onemarkanswer[id]}][mark]";   ?>"  <?php echo $disabled;  ?>value="<?php echo $onemarkanswer[mark]; ?>" maxlength="1" min="0" max="<?php echo $onemarkanswer[mark_per_qtn] ; ?>" type="text" class="marks required number" id="<?php echo "fillUP".$j; ?>"    title="Enter mark"/>
    </td>
  </tr>
</table>
	</li>
...
<ul class="w800">
  ...
  <tr>
    ...
    <td valign="top" align="right"><input name="<?php echo "markforQuestion[{$subjectiveanswer[id]}][mark]";   ?>"  value="<?php echo $subjectiveanswer[mark]; ?>" maxlength="2" max="<?php echo "{$subjectiveanswer[marks_per_question]}";?>" type="text" class="marks required number" id="<?php echo "part4mark1".$i.$j; ?>"    title="Enter mark"/></td>
  </tr>
</table>
	</li>
    </ul>
