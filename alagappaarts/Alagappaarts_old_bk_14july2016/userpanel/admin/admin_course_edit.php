  ...
  <tbody><tr>
    ...
    <input type="hidden" size="8" name="txtCourseExam[]" value="<?php echo $courseexam['courseexamid'] ?>">
		...
		?>
                ...
                <td valign="top" align="left">
                <input type="text" size="8" name="txtNoofQuestion[]" class="classNoofQuestion required number" value="<?php echo $courseexam['no_of_questions'] ?>"></td>
...
<br />
		...
		<div class="durationyear"><span class="year">Hours </span><input type="text" class="w65 fL mR10" name="txthour" value="<?php echo $getCourse->fields['exam_duration_hour'];?>"></div>
        <div class="durationmonth"><span class="year">Mins   </span><input type="text" class="w65" name="txtmin" value="<?php echo $getCourse->fields['exam_duration_minute'];?>"></div> </li>
        <li>
        <label>Exam attempt limit    :<strong class="star">*</strong> </label>
		<input name="txtlimit" type="text" value="<?php echo $getCourse->fields['exam_attempt_limit'];?>" />  </li>
        <li>
