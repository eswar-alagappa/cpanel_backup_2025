...
<ul>";
	...
	switch($arrayfin[$arrayIndex]['questiontype'])
	{
	  ...
	  <label><input type='radio' name='questAnswer' value='0' />".$arrayfin[$arrayIndex]['choice1']."</label>
	   <label><input type='radio' name='questAnswer' value='1' />".$arrayfin[$arrayIndex]['choice2']."</label>
	    <label><input type='radio' name='questAnswer' value='2' />".$arrayfin[$arrayIndex]['choice3']."</label>
