...
<form action="<?php echo site_url('music/student/online_submit_quiz/');?>" method="post" id="testform" onsubmit="showquestion('0');">
<?php 
$category_number=0;
...
$(document).bind('keydown keyup', function(e) 
 {
	...
	{   
		 var clickedcrr = confirm("CTRL + R is disable, If you press ok your exam result will not be stored");
			if(clickedcrr)
			{
				window.location = "<?= base_url('music/student/event_error/'.$result->course_id.'~ctrlr') ?>";
			}
			else
			{
				return false;
	 ...
	 { 
		...
		else
		{
		  var clickedf5 = confirm("F5 is disable If you press ok your exam result will not be stored");
			...
			if(clickedf5)
			{
				window.location = "<?= base_url('music/student/event_error/'.$result->course_id.'~f5') ?>";
			}
			else
			{
				return false;
