...
<form action="<?php echo base_url().'music/student/add_feedback'?>" method="post" id="frmSendAnnouncement">
    <div class="contentOuter">
      ...
      <li class="btn"><input type="submit" class="saveBtn" value="Send" name="submit">
		...
		<a style="padd" href="<?php echo base_url().'music/student/feedback'?>" class="cancelBtn"><span style="float:none;position:relative;top:8px;">Cancel</span></a>
		</div>
