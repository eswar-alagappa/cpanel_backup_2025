                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                <form method="post" action="<?php echo site_url('music/admin/qbank/add_new/2');?>">
...
<input class="form-control"  type="text" name="option[]" value="<?php echo ((isset($post_set['option']) && !empty($post_set['option'])) ? $post_set['option'][0] : '') ?>" placeholder="Answer"> 
