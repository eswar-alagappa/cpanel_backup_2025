...
<tr><th >Unassigned Question</th><td><?php echo $result->m_type;?></td></tr>
...
if($result2==true){ echo "<span style='color:red'> <a href='".site_url('music/admin/result/view_answer/'.$result->rid)."'> ( Essay Evaluation Pending ) </a></span>";}?></td></tr>
...
<table id="detail">
<tr><td ><a href="<?php echo site_url('music/admin/result/view_answer/'.$result->rid );?>" class="btn btn-success">View Answers</a></td>
