                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                <form method="post" action="<?php echo site_url('music/admin/qbank/edit_question/'.$result['0']['qid'].'/5');?>">
...
<input type="text" name="option[]" value="<?php echo $option_value['option_value'];?>"><div class="space"></div>Ex: option<?php echo $okey+1; ?>=Answer<?php echo $okey+1; ?>  </td></tr>
...
?>
<tr><td valign="top"><?php echo $op.")"; ?> &nbsp;&nbsp; </td><td valign="top"><input type="text" name="option[]"><div class="space"></div>Ex: option<?php echo $op; ?>=Answer<?php echo $op; ?> </td></tr>
<?php
$op++;
}
}
