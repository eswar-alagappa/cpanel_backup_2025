                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                   <form method="post" action="<?php echo site_url('music/admin/qbank/add_new/6');?>">
                                        ...
                                        <div class="form-group">
                                            <label>Question Type</label>
												...
												<option value="6" selected>True / False</option>
												</select>
...
<tr><td valign="top">2) &nbsp;&nbsp; <input type="radio" id="radiobtn" value="1" <?php echo (( isset($post_set['score']) && $post_set['score']==1) ? 'checked' : ''); ?> name="score"><?php $op="3"; ?></td><td valign="top">
