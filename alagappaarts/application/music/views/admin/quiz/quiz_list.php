...
//if($logged_in['su']=="1"){
?>
 <a href="<?php echo site_url('music/admin/quiz/add_new');?>" class="btn btn-success">Add new</a>
<?php 
//}
?>
...
<td data-th="Action">
<!--<a href="<?php echo site_url('music/admin/quiz/attempt/'.$row->quid);?>"  class="btn btn-warning btn-xs">Attempt</a>
&nbsp;&nbsp;-->
<?php
if($logged_in=="1"){
?>
<!--<a href="javascript: if(confirm('Do you really want to remove this quiz?')){ window.location='<?php echo site_url('music/admin/quiz/remove_quiz/'.$row->quid );?>'; }" class="btn btn-danger btn-xs">Remove</a>--> <a href="<?php echo site_url('music/admin/quiz/edit_quiz/'.$row->quid );?>"  class="btn btn-info btn-xs">Edit</a>
<?php
}
?>
</td>
...
<a href="<?php echo site_url('music/admin/quiz/index/'.$back);?>" class="btn btn-primary">Back</a>
&nbsp;&nbsp;
<?php
 $next=$limit+($this->config->item('number_of_rows'));  ?>

<a href="<?php echo site_url('music/admin/quiz/index/'.$next);?>" class="btn btn-primary">Next</a>
