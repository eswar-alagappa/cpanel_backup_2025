...
<script type="text/javascript" src="<?php echo base_url();?>/music_js/basic.js?rd=<?php echo time();?>"></script>
 <style>
...
?>
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
              <div class="navbar-header">
				  ...
				  <a href=""><img class="logoImg" src="<?php echo base_url();?>music_assets/home/images/spacer.gif"></a>
              ...
              <div class="navbar-default sidebar" role="navigation" >
                  <div class="sidebar-nav navbar-collapse" aria-expanded="false" style="height: 1px;">
                      <ul class="nav in" id="side-menu">
                         ...
                         //if($logged_in['su']=="1"){ ?>
                          <li>
                              <a href="<?php echo site_url('music/admin/qbank/index');?>"  ><i class="fa fa-question fa-fw"></i> Question Bank</a>
                          </li>
                          <?php 
                        //}
                        ?>
                          <li>
                              <a href="<?php echo site_url('music/admin/quiz/index');?>" ><i class="fa fa-check fa-fw"></i> Quiz</a>
                          </li>
                          <li>
                          <?php 
                         if($logged_in=="1"){ ?>
                             <a href="<?php echo site_url('music/admin/result/index');?>"  ><i class="fa fa-line-chart fa-fw"></i> Result</a>
                          <?php 
                        }else{
                          ?>
                            <a href="<?php echo site_url('music/admin/result/user');?>"  ><i class="fa fa-line-chart fa-fw"></i> Result</a>
                        ...
                        ?>-->
						<li>
                              <a href="<?php echo site_url('music/admin/master/dashboard');?>"  ><i class="fa fa-cog fa-fw"></i> Back To Admin</a>
                          </li>
                      </ul>
                  </div>
                  <!-- /.sidebar-collapse -->
