                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="panel-group" id="accordion">
                               <a href="<?php echo site_url('music/admin/result/view/'.$id.'/'.$result->quid);?>"  class="btn btn-danger">Back</a>
...
$match_ans=0;
$fillin_ans=0;
$short_ans_pos_not_attempted=array(); //echo '<pre>';print_r($assigned_question[2]);
	foreach($assigned_question[2] as $valuew_fil){
		if($valuew_fil['q_type']=="2"){
		//print_r($valuew_fil);
			$given_ans_fillups[]=$valuew_fil['essay_cont'];
			$fillInBlank_status[$valuew_fil['q_id']] = $valuew_fil['essay_status'];
		}
		if($valuew_fil['q_type']=="3"){
		//print_r($valuew_fil);
			$given_ans_short[]=$valuew_fil['essay_cont'];
			$shortAnsStatus[$valuew_fil['q_id']] = $valuew_fil['essay_status']; 
		}
		...
		if($valuew_fil['q_type']=="4"){
			$given_ans_essay[$valuew_fil['q_id']]=$valuew_fil['essay_cont'];
			$essay_status[$valuew_fil['q_id']]=$valuew_fil['essay_status'];
		}
		if($valuew_fil['q_type']=="5"){
		//print_r($valuew_fil);
			$given_ans_match[]=$valuew_fil['essay_cont'];
			$matchthefollowing[$valuew_fil['q_id']] = $valuew_fil['essay_status']; 
			
		}
		if($valuew_fil['q_type']=="6"){
		//print_r($valuew_fil);
			$given_ans_essay[]=$valuew_fil['essay_cont'];
			$essay_status[]=$valuew_fil['essay_status']; 
	...
	//echo '<pre>';print_r($assigned_question[0]);die;
...
<!--<td valign="top"><?php if($option['score']=="1"){ ?><img src="<?php echo base_url();?>images/tick-icon.png"><?php } ?></td>-->
</tr></table>
</td></tr>
<?php
}
...
<td style="border:0px;width:750px;"> <?php echo $option['option_value'];?> </td>
<!--<td valign="top"><?php if($option['score']>"0"){ ?><img src="<?php echo base_url();?>images/tick-icon.png"><?php } ?></td>-->
</tr></table>
</td></tr>
<?php
}
...
<!--<td valign="top"><?php if(strip_tags($option['option_value'])==$given_ans_fillups[$fill]){ ?><img src="<?php echo base_url();?>images/tick-icon.png"><?php } ?></td>-->
</tr></table>
</td></tr>
<?php
}
...
<?php 
	...
	if($logged_in=="1"){ //echo 'QId->'.$question['qid']; //echo '<pre>1->';print_r($fillInBlank_status);
	$qId = $question['qid'];
if($fillInBlank_status[$qId]=="0"){?>
	
<input type="text" id="essay_score<?php echo $qId;?>" placeholder="Enter the score">
<span id="scorebtn<?php echo $qId;?>"  ><input type="button" value="ADD SCORE"  onClick="add_score('<?php echo $question['qid'];?>','<?php echo $id;?>','<?php echo $qId;?>');"  class="btn btn-default"></span>	
<?php	
}
	}
?>
...
?>
<tr><td><table>
<tr><td style="width:10px; border:0px;"> <td style="border:0px;width:750px;"> <?php echo "Answer:<br>".$given_ans_essay[$question['qid']];?> </td></td></tr></table>
</td></tr><tr>
<td>
<?php //echo '<pre>question->';print_r($question); echo '<pre>id->->';print_r($id); echo '<pre>123->';print_r($essay_status);
	$logged_in=$this->session->userdata('admin_logged_in');
	if($logged_in=="1"){
		$qId = $question['qid'];
if($essay_status[$qId]=="0"){?>
	
<input type="text" id="essay_score<?php echo $qId;//$essay_ans;?>" placeholder="Enter the score">
<span id="scorebtn<?php echo $qId;//$essay_ans;?>"  ><input type="button" value="ADD SCORE"  onClick="add_score('<?php echo $question['qid'];?>','<?php echo $id;?>','<?php echo $qId;//$essay_ans;?>');"  class="btn btn-default"></span>	
<?php	
}
	}
?>
...
<tr><td><div class="count_btn" style="background:#212121;">&nbsp;</div> Not Validated</td></tr>
</table>
