                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>music/admin/centers/update<?php echo $urlArg; ?>" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
										...
										<div class="ln_solid"></div>
										 ...
										 <div class="item form-group">                                            
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="exp_music" value="<?php echo (isset($post_set['exp_music']) && !empty($post_set['exp_music']) ? $post_set['exp_music'] : $selectedValues->experience_music);?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="exp_music" placeholder="Experience in Music"  type="text">
