        ...
        <div id="wrapper">
            <div id="login" class="animate form" style="<?php echo ((isset($_POST['login']) && !empty($_POST['login']) && $_POST['login']) ? '' : ((isset($_POST['register']) && !empty($_POST['register']) && $_POST['register']) ? 'display:none' : '')); ?>" >
                <section class="login_content">
                    <form id="myLoginForm" name="myLoginForm" method="POST" action="<?php echo base_url(); ?>music/admin/login#tologin">
                        <h1>Login Form</h1>
                        <div>
                        ...
                        <div class="separator">
                            ...
                            <!--<p class="change_link">New to site?
                                <a href="<?php echo base_url().'music/admin/login#toregister';?>" class="to_register"> Create Account </a>
                            </p>-->
                            <div class="clearfix"></div>
                            <br />
                            <div>
            ...
            <div id="register" class="animate form" style="<?php echo ((isset($_POST['register']) && !empty($_POST['register']) && $_POST['register']) ? '' : ((isset($_POST['login']) && !empty($_POST['login']) && $_POST['login']) ? 'display:none' : '')); ?>" >
				...
				<section class="login_content">
                    <form id="myRegisterForm" name="myRegisterForm" method="POST" action="<?php echo base_url(); ?>music/admin/login/register#toregister">
                        ...
                        <div class="separator">
                            ...
                            <p class="change_link">Already a member ?
                                <a href="<?php echo base_url().'music/admin/login#tologin'; ?>" class="to_register"> Log in </a>
                            </p>
                            <div class="clearfix"></div>
                            <br />
                            <div>
