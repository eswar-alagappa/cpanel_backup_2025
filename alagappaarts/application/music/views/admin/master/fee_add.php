                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>music/admin/master/fees/add" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <select class="form-control col-md-7 col-xs-12" name="course_type" id="course_type">
													...
													<?php if(!empty($course_type)) { foreach($course_type as $k=>$type){?>
														<option value="<?php echo $k; ?>" <?php echo (isset($post_set['course_type']) && !empty($post_set['course_type'])  && ($post_set['course_type']== $k) ? 'selected' : '');?>><?php echo $type; ?></option>
													<?php } } ?>
											   </select>
          ...
          <button type="button" id="btnDel" name="btnDel" class="btn btn-danger">remove section above</button>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
												...
												<a href="<?php echo base_url(); ?>music/admin/master/fees/" class="btn btn-primary" onclick="return confirm('Are you sure you want to leave this page?');"> Cancel </a>
			...
			$(document).ready( function() { 	
				...
				$('#course_type').change(function(){ 
				 ...
				 $('.program_id,#course_type').change(function(){ //any select change on the dropdown with id country trigger this code
							...
							{ 
								$.ajax({
									type: "POST",
									url: "<?php echo base_url(); ?>music/admin/master/ajaxPgm",
									data: {field_id:'program_id',course_type:courseType, field_val : program,type:'courses'},
									dataType:"json",
