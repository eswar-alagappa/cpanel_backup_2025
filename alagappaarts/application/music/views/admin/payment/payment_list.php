                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
								...
								<form id="frmStudentsearch" method="post" action="<?php echo base_url().'music/admin/payment/index' ?>">
										...
										<?php if( !empty($payments)){ 
                                            ...
                                            <tr class="even pointer">
                                                ...
                                                <td><?php echo $payment['outstandingAmt'] ?></td>
                                                 ...
                                                 <td class=" last">
												<?php if($payment["username"]!=null){
												$PayLink =  base_url().'music/admin/payment/add_check_pay/'.$payment['user_id'];
