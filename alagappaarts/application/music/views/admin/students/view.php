                                ...
                                <div class="x_content">
									...
									<div class="addProgramForm">
									  <ul>
										...
										<span><?php echo $selectedValues->music_experience ?></span>  
										</li> 
										
										<li>
										<label>Music Type : </label>
										<span> <?php if ($selectedValues->music_type== 1) { echo "Instrumental Music"; } else if ($selectedValues->music_type== 2) { echo "Vocal Music"; }?></span>    
										</li> 
										...
										<span><?php echo $selectedValues->special_accomplishment ?></span>  
										 ...
										 <li class=""><a class="saveBtn btn btn-round btn-warning" href="<?php echo base_url().'music/admin/students/index'?>">Back</a>
