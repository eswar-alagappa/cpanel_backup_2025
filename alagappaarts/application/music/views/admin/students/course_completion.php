...
<div class="right_col" role="main">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>music/admin/students/course_completion<?php echo $urlArg;?>" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <select class="form-control col-md-7 col-xs-12" name="music_type" id="music_type" >
													...
													<?php if(!empty($music_type)) { foreach($music_type as $k=>$type){?>
														<option value="<?php echo $k; ?>" <?php echo ((isset($post_set['music_type']) && !empty($post_set['music_type'])  && ($k==$post_set['music_type'])) ? 'selected="selected"' : (( !isset($post_set['music_type']) && isset($defaultMusicType) && !empty($defaultMusicType) && $defaultMusicType==$k) ? 'selected' : ''));?>><?php echo stripslashes($type); ?></option>
													<?php } } ?>
											   </select>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												<div class="stud_detail">
													<ul>
														...
														<li><span>Program Enrolled : </span><span class="pname"><?php echo stripslashes($enroll_detail->programName)?></span></li>
    ...
    margin-top: 10px;">
									   ...
									   <p style="text-align: center; font-size: large; font-weight: 500;"> Mark details</p>
										
										<div class="item form-group">
                                            					
											<div class="col-md-12 col-sm-12 col-xs-12 pay">
												<table class="result_exam" cellspacing="0" cellpadding="0" border="2" style="margin: auto;
    margin-top: 10px;">
													<thead>													
													  <tr>
														<th>EXAM DATE</th>
        ...
        $(this).change(function(){ 
            ...
            $("#"+divId).show('slow');
						...
						$('.program_id').change(function(){ //any select change on the dropdown with id country trigger this code
							...
							var musictype=$("#music_type").val();
							if(program !="")
							{ 
								$.ajax({
									type: "POST",
									url: "<?php echo base_url(); ?>music/admin/students/ajaxCourseCompletion",
									data: {program_id : program,user_id:<?php echo $arg?>,type:'courses','music_type':musictype},
									dataType:"json",
									...
									success: function(value) //we're calling the response json array 'cities'
									{
									    ...
									    //$('#dvLoading').removeClass('imgloading'); 
											...
											if( Exam !== false){
												...
												$('#user_program_id').val(Exam[0].user_program_id);
												$('#hiddenGraduateStatus').val( ((Exam[0].graduation_status=='Y') ? 1 : '') );
												$('#comment').val(Exam[0].graduation_status_comments);
												$('input[name="graduate_date"]').val(Exam[0].completion_date);
												$('#grade').val(Exam[0].grade);
												//$('input[name="graduation_status"]').val(Exam[0].graduation_status);
												if( Exam[0].graduation_status == 'Y'){
