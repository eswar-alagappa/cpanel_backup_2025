<div class="right_col" role="main">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>music/admin/students/update<?php echo $urlArg;?>" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
          ...
          <input type="radio" id="inlineRadio1" value="Male" name="gender" <?php if( !empty($post_set['gender']) && $post_set['gender'] =='Male') { ?> checked <?php }elseif($selectedValues->gender=='Male'){?>checked<?php }else{ ?>checked<?php } ?> >
          <label for="inlineRadio1"> Male</label>
        </div>
        <div class="radio radio-info radio-inline">
          <input type="radio" id="inlineRadio2" value="Female" name="gender" <?php if(!empty($post_set['gender']) && $post_set['gender'] =='Female') { ?> checked <?php }elseif($selectedValues->gender=='Female'){?>checked<?php } ?> >
          <label for="inlineRadio2"> Female</label>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <select class="form-control col-md-7 col-xs-12" name="music_type" id="music_type" >
													...
													<?php if(!empty($music_type)) { foreach($music_type as $k=>$type){?>
														<option value="<?php echo $k; ?>" <?php echo ((isset($post_set['music_type']) && !empty($post_set['music_type'])  && ($k==$post_set['music_type'])) ? 'selected="selected"' : ((isset($selectedValues->music_type) && !empty($selectedValues->music_type)  && ($k == $selectedValues->music_type) ? 'selected="selected"' :'')));?>><?php echo stripslashes($type); ?></option>
													<?php } } ?>
											   </select>
										...
										<div class="ln_solid"></div>
										 ...
										 <div class="item form-group">                                            
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="exp_music" value="<?php echo (isset($post_set['exp_music']) && !empty($post_set['exp_music']) ? $post_set['exp_music'] : $selectedValues->music_experience);?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="exp_music" placeholder="Experience in Music"  type="text">
