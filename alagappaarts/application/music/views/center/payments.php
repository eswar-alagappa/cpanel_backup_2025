        ...
        <div class="col-md-12 col-md-offset-0 bg-border">
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td><?php echo $paymentList[$i]->firstname.' '.$paymentList[$i]->lastname; ?></td>
					<td><?php echo stripslashes($paymentList[$i]->programName); ?></td>
					<td><?php echo $paymentList[$i]->payment_option; ?></td>
                    <td><?php echo $paymentList[$i]->paid_on; ?></td>
					<td><?php echo $paymentList[$i]->amount; ?></td>
					<td><?php echo $paymentList[$i]->payment_mode; ?></td>
					<td><?php echo $paymentList[$i]->status; ?></td>
			...
			<?php }else{ ?>
			<div class='warning'> NO PAYMENTS MADE.  </div> 
			<?php } ?>
        </div>
    </div>
