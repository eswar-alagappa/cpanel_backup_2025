...
<div class="row">
	<h2><span>students </span>
		...
		<span>
		<form method="post" id="form" action="<?php echo base_url(); ?>music/center/test_excel">
        ...
        <div class="col-md-12 col-md-offset-0 bg-border">
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
					...
					<td><a href="<?php echo base_url()?>music/center/student_view/<?php echo $studentList[$i]->user_id ?>"><img width="20" height="18" title="View" src="<?php echo base_url()?>assets/home/images/view-btn.png"></a></td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
