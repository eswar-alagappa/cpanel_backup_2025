...
<div class=" wrapper">
  <div class="header">
    <div class="headerTop">
	  ...
	  <div class="menu">
        <ul id="nav">
			<li class="top"><a href="<?php echo base_url()?>music/center/students" class="top_link">Students</a></li>
			<li><a href="<?php echo base_url()?>music/center/exam_schedule">Exams</a></li>
			<li><a href="<?php echo base_url()?>music/center/payments">Payments</a></li>
			<li><a href="<?php echo base_url()?>music/center/exam_result">Result </a></li>
      ...
      <div class="menuBottom">
       ...
       <ul>
          ...
          <li class="homeIcon"><a href="<?php echo base_url().''?>">website Home</a></li>
            ...
            <li class="dashboardIcon"><a href="<?php echo base_url().'music/center/index'?>">dashboard</a></li>

          <li class="profilenav"><a href="<?php echo base_url().'music/center/profile'?>">Profile</a></li> 

          <li class="logoutIcon "><a class="end" href="<?php echo base_url().'music/center/logout'?>">Logout</a></li>
