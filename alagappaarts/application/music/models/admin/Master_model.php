...
function __construct()
	...
	public function getSelected_List_withcondition($table, $selected_field, $id, $condition, $val )
	{
		if( !empty($table) && !empty($selected_field) && !empty($id) )
		{
			$this->db->select('*');
