  ...
  <?php $i=1;
	if(isset($pgmCourse) && !empty($pgmCourse)){
		...
		<div class="programsContent" id="content">
			...
			<h2>Programs</h2>
		<p><img width="234" height="290" alt="certificate-program" src="http://alagappaarts.com/vaasthu/wp-content/uploads/sites/4/2011/09/certificate-program1.jpg" class="alignleft size-full wp-image-153"><img width="234" height="290" alt="diploma-program" src="http://alagappaarts.com/vaasthu/wp-content/uploads/sites/4/2011/09/diploma-program1.jpg" class="alignleft size-full wp-image-151"><img width="234" height="290" alt="degree-program" src="http://alagappaarts.com/vaasthu/wp-content/uploads/sites/4/2011/09/degree-program1.jpg" class="alignleft size-full wp-image-152"></p>
