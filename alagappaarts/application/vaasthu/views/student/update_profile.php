...
<div class="content">
     <div class="contentOuter">
      <h2>Edit Profile</h2>
       <form enctype="multipart/form-data" method="post" name="formStudentadd" action="<?php echo base_url(); ?>dance/student/edit_profile" id="frmprofileedit">
...
<li>
        ...
        <a class="cancelBtn" href="<?php echo base_url().'dance/student/profile'?>">Cancel</a>
        </li>
      </ul>
      </div>
      </div>
