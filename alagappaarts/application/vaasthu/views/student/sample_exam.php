  ...
  window.onunload=function(){null};
    ...
    <div class="contentOuter">
     ...
     <div class="contentInner">
      ...
      <ul>
      <li><a rel="17" href="javascript:;" class="active">Sample test</a></li>     
     
      </ul>
      </div>
      </div>
      <div class="onlineExamsRight"><div class="title">Sample test</div><div class="subTitle">Instructions</div><div class="onlineExamsContent"><div class="onlineExamsContentTop"><div class="onlineExamsContentTopLeft">There are part of questions<br><br>1. Multiple Choice<br>2. Fill in the Blank<br>3. Match the following<br>4.  Subjective 5 Marks<br></div><div class="onlineExamsContentTopRight"><span>Marks</span>:100<br>
...
<div class="browserWarningRight"><a href="javascript:;" class="" id="" onClick="javascript:checkbox_validate();"><img width="164" height="115" src="<?php echo base_url() ?>assets/home/images/start-quiz-btn.gif"></a></div>
	...
	if(document.getElementById('agree').checked==true){
		window.location='<?php echo site_url('dance/student/sample_exam_process');?>';
		}else{
