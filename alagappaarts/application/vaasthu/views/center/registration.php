...
<div class="fr mB10">
<a target="_blank" href="<?php echo base_url() ?>assets/home/centre_registration_form.pdf"><img width="270" height="30" src="http://alagappaarts.com/dance/wp-content/themes/dance/images/download-btn.gif"></a>
</div>

   <div class="registerFormOuter">
<div class="fl"><img width="5" height="44" src="http://alagappaarts.com/dance/wp-content/themes/dance/images/register-title-bg-left.png"></div><div class="registerFormTitle">Center Registration Form</div><div class="fr"><img width="5" height="44" src="http://alagappaarts.com/dance/wp-content/themes/dance/images/register-title-bg-right.png"></div>
...
<form enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>vaasthu/center/registration" id="frmCentreadd">
