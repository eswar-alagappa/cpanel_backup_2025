...
<li><label>Address:  <?php echo $personal->address ?></label>
  ...
  <?php echo $personal->centerName ?></label>
     ...
     <fieldset class="w100 pgmDetail">
        ...
        <li> <label>Date of joining : <?php echo ((isset($pgmEnroll->enrollment_date) && !empty($pgmEnroll->enrollment_date)) ? date('d-M-Y',strtotime($pgmEnroll->enrollment_date)) : '') ?></label>	</li>
          ...
          <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tabelView">
            <tbody>
              ...
              <tr>
				...
				<tr class="">
					<td><?php echo date('d-M-Y',strtotime($examTaken->exam_startdate)); ?></td>
					<td><?php echo $examTaken->course_code ?></td>
					<td> <?php echo $examTaken->score ?>  </td>
					<td> <?php echo $examTaken->result ?>  </td>
					<td><?php echo $examTaken->grade ?> </td>
				</tr>  
