                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
								...
								<?php $urlArg = ((isset($arg) && !empty($arg)) ? '/'.$arg : '');?>
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>vaasthu/admin/payment/add_check_pay<?php echo $urlArg; ?>" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
          ...
          <label for="inlineRadio2"> Partial</label>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
												...
												<a href="<?php echo base_url(); ?>vaasthu/admin/payment/index" class="btn btn-primary" onclick="return confirm('Are you sure you want to leave this page?');"> Cancel </a>
