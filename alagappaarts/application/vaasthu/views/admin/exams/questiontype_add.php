                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>vaasthu/admin/exams/questiontypes/add" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
