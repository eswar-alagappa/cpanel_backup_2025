                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>vaasthu/admin/master/fees/add" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
				...
				$(document).on("change","[id^='p_']",function(){
				 ...
				 $('.program_id').change(function(){ //any select change on the dropdown with id country trigger this code
							...
							{ 
								$.ajax({
									type: "POST",
									url: "<?php echo base_url(); ?>vaasthu/admin/master/ajaxPgm",
