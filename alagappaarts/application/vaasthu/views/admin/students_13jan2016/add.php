<div class="right_col" role="main">
          ...
          <input type="radio" id="inlineRadio1" value="M" name="gender" <?php if( !empty($post_set['gender']) && $post_set['gender'] =='Male') { ?> checked <?php }else{ ?>checked<?php } ?> >
          <label for="inlineRadio1"> Male</label>
        </div>
        <div class="radio radio-info radio-inline">
          <input type="radio" id="inlineRadio2" value="F" name="gender" <?php if(!empty($post_set['gender']) && $post_set['gender'] =='Female') { ?> checked <?php } ?> >
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <select class="form-control col-md-7 col-xs-12" name="program_id" id="program_id">
													...
													<?php if(!empty($programs)) { foreach($programs as $k=>$pgm){?>
														<option value="<?php echo $pgm->program_id; ?>" <?php echo (isset($post_set['program_id']) && !empty($post_set['program_id'])  && ($post_set['program_id']== $pgm->program_id) ? 'selected' : '');?>><?php echo $pgm->name; ?></option>
													<?php } } ?>
											   </select>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <select class="form-control col-md-7 col-xs-12" name="stream" id="stream">
													...
													<?php if(!empty($sreatm)) { foreach($sreatm as $k=>$str){?>
														<option value="<?php echo $k; ?>" <?php echo (isset($post_set['stream']) && !empty($post_set['stream'])  && ($post_set['stream']== $k) ? 'selected' : '');?>><?php echo $str; ?></option>
													<?php } } ?>
											   </select>
