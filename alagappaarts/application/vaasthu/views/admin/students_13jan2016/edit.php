                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>dance/admin/students/update<?php echo $urlArg;?>" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
        ...
        <div class="radio radio-info radio-inline">
          ...
          <label for="inlineRadio2"> Female</label>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <select class="form-control col-md-7 col-xs-12" name="program_id" id="program_id">
													...
													<?php if(!empty($programs)) { foreach($programs as $k=>$pgm){?>
														<option value="<?php echo $pgm->program_id; ?>" <?php echo (isset($post_set['program_id']) && !empty($post_set['program_id'])  && ($post_set['program_id']== $pgm->program_id) ? 'selected' : 
														((isset($selectedValues->program_id) && !empty($selectedValues->program_id)  && ($selectedValues->program_id== $pgm->program_id)) ? 'selected' :''));?>><?php echo $pgm->name; ?></option>
													<?php } } ?>
											   </select>
										...
										<div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <select class="form-control col-md-7 col-xs-12" name="stream" id="stream">
													<option value="">Select Stream</option>
													<?php if(!empty($sreatm)) { foreach($sreatm as $k=>$str){?>
														<option value="<?php echo $k; ?>" <?php echo (isset($post_set['stream']) && !empty($post_set['stream'])  && ($post_set['stream']== $k) ? 'selected' : 
														((isset($selectedValues->stream) && !empty($selectedValues->stream)  && ($selectedValues->stream== $k)) ? 'selected' :''));?>><?php echo $str; ?></option>
													<?php } } ?>
											   </select>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
												...
												<a href="<?php echo base_url(); ?>dance/admin/students/" class="btn btn-primary" onclick="return confirm('Are you sure you want to leave this page?');"> Cancel </a>
