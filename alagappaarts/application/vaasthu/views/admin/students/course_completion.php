                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>vaasthu/admin/students/course_completion<?php echo $urlArg;?>" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												<div class="stud_detail">
													<ul>
														...
														<li><span>Program fee : </span><span class="pgm_fee"><?php echo '$ '.$paymentList[0]->Total_fee?></span></li>
													</ul>
												</div>
											</div>
										</div>
            ...
            $("#"+divId).show('slow');
						...
						$('.program_id').change(function(){ //any select change on the dropdown with id country trigger this code
							...
							{ 
								$.ajax({
									type: "POST",
									url: "<?php echo base_url(); ?>vaasthu/admin/students/ajaxCourseCompletion",
