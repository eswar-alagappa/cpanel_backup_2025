...
<form method="post" action="<?php echo site_url('vaasthu/admin/result/get_report');?>">
...
<div class="searchbox" id="searchbox">
 <form method="post" action="<?php echo site_url('vaasthu/admin/result/index');?>">
...
<td data-th="Action">
<a href="<?php echo site_url('vaasthu/admin/result/view/'.$row->rid.'/'.$row->course_id.'/'.$row->uid);?>" title="Result View" alt="Result View" class="fa fa-envelope-o"></a>  
<!--<a href="<?php echo site_url('vaasthu/admin/result/view/'.$row->rid.'/'.$row->course_id.'/'.$row->uid);?>" title="Result Announce" alt="Result Announce" class="fafa-envelope"></a>--> 
<?php
if($logged_in['su']=="1" && $logged_in['id']=="1"){
?>
<a href="<?php echo site_url('vaasthu/admin/result/remove_result/'.$row->rid);?>" class="btn btn-danger btn-xs">Remove</a>
<?php
}
?>
...
if($logged_in=="1"){
?>
<a href="<?php echo site_url('vaasthu/admin/result/index/'.$back);?>"   class="btn btn-primary">Back</a>
&nbsp;&nbsp;
<?php
 $next=$limit+($this->config->item('number_of_rows'));  ?>

<a href="<?php echo site_url('vaasthu/admin/result/index/'.$next);?>"   class="btn btn-primary">Next</a>
<?php
}else{
?>
