...
if( isset($resultstatus) && !empty($resultstatus) && $resultstatus){ echo "<div class='alert alert-success'>".$resultstatus."</div>"; }
 ...
 <a href="<?php echo site_url('vaasthu/admin/qbank/add_new');?>" class="btn btn-success">Add new</a>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="post" action="<?php echo site_url('qbank/remove_qids/'.$limit);?>" id="removeqids">
								...
								<td data-th="Action">
								<a href="javascript: if(confirm('Do you really want to remove this question?')){ window.location='<?php echo site_url('vaasthu/admin/qbank/remove_question/'.$row->qid );?>'; }" class="btn btn-danger btn-xs">Remove</a> 
								 <a href="<?php echo site_url('vaasthu/admin/qbank/edit_question/'.$row->qid.'/'.$row->q_type );?>" class="btn btn-info btn-xs">Edit</a></td>
								</tr>
								<?php
								}
								}
...
<a href="<?php echo site_url('vaasthu/admin/qbank/index/'.$back.'/'.$fcid);?>"  class="btn btn-primary">Back</a>
&nbsp;&nbsp;
<?php
 $next=$limit+($this->config->item('number_of_rows'));  ?>

<a href="<?php echo site_url('vaasthu/admin/qbank/index/'.$next.'/'.$fcid);?>"  class="btn btn-primary">Next</a>
&nbsp;&nbsp;
