...
if($result2==true){ echo "<span style='color:red'> <a href='".site_url('vaasthu/admin/result/view_answer/'.$result->rid)."'> ( Essay Evaluation Pending ) </a></span>";}?></td></tr>
...
<table id="detail">
<tr><td ><a href="<?php echo site_url('vaasthu/admin/result/view_answer/'.$result->rid );?>" class="btn btn-success">View Answers</a></td>
