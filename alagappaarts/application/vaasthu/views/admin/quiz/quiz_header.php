              ...
              <div class="navbar-default sidebar" role="navigation" >
                  <div class="sidebar-nav navbar-collapse" aria-expanded="false" style="height: 1px;">
                      <ul class="nav in" id="side-menu">
                         ...
                         //if($logged_in['su']=="1"){ ?>
                          <li>
                              <a href="<?php echo site_url('vaasthu/admin/qbank/index');?>"  ><i class="fa fa-question fa-fw"></i> Question Bank</a>
                          </li>
                          <?php 
                        //}
                        ?>
                          <li>
                              <a href="<?php echo site_url('vaasthu/admin/quiz/index');?>" ><i class="fa fa-check fa-fw"></i> Quiz</a>
                          </li>
                          <li>
                          <?php 
                         if($logged_in=="1"){ ?>
                             <a href="<?php echo site_url('vaasthu/admin/result/index');?>"  ><i class="fa fa-line-chart fa-fw"></i> Result</a>
                          <?php 
                        }else{
                          ?>
                            <a href="<?php echo site_url('vaasthu/admin/result/user');?>"  ><i class="fa fa-line-chart fa-fw"></i> Result</a>
                        ...
                        ?>-->
						<li>
                              <a href="<?php echo site_url('vaasthu/admin/master/index');?>"  ><i class="fa fa-cog fa-fw"></i> Back To Admin</a>
                          </li>
                      </ul>
                  </div>
                  <!-- /.sidebar-collapse -->
