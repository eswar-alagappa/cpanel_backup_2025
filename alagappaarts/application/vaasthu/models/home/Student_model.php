...
function __construct()
   ...
   public function getListactiveState($table)
	...
	public function getData( $table, $table2, $field, $user_id)
	{
		...
		$this->db->select('u.*,up.*,cd.*,ca.*,ca.address as caddress,ca.name as cname,ca.city as ccity,ca.state as cstate, ca.country as ccountry,ca.zip as czip,ca.contact as ccontact, up.dob as user_dob,up.city as ucity, up.state as ustate, up.country as ucountry, up.zip as uzip, u.email as uemail, up.address as uaddress,u.username as username');
