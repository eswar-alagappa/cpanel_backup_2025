...
$db['db1']['username'] = 'appaarts_vaasthu';
$db['db1']['password'] = 'ATb)@SUol0D9';
$db['db1']['database'] = 'appaarts_newvaasthu';
...
$db['db1']['encrypt'] = FALSE;
$db['db1']['compress'] = FALSE;
$db['db1']['failover'] = array();
$db['db1']['save_queries'] = TRUE;
