...
<div class="content">
     <div class="contentOuter">
      <h2>Edit Profile</h2>
       <form enctype="multipart/form-data" method="post" name="formStudentadd" action="<?php echo base_url(); ?>dance/center/edit_profile" id="frmprofileedit">
...
<li><label>Address: </label>
     ...
     <ul>
      ...
      <ul><li class="btn"><input type="submit" class="submitBtn fL" value="Update" name="btnCenteredit">
          <a class="cancelBtn" href="<?php echo base_url().'dance/center/profile'?>">Cancel</a>
        </li>
	  </ul>
      </div>
