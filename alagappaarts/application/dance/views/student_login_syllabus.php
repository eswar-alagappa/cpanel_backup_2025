...
<h2><span>Syllabus Student Login</span></h2>
</div>
<div class="apaaContent">
<!--<div class="centerregisterBtn"><a href="<?php echo base_url().'dance/student/registration' ?>"><img width="249" height="101" src="../assets/home/images/student-btn.png"></a></div>

<div class="centerregisterBtn"><a href="<?php echo base_url().'dance/center/registration' ?>"><img width="249" height="101" src="../assets/home/images/center-btn.png"></a></div>
-->
  <div class="loginBg">
...
<?php } ?></span>
  ...
  <form action="<?php echo base_url().'dance/syllabuslogin'?>" method="post" id="frmLogin">
...
<?php echo form_error('txtPassword'); ?>
  ...
  <input type="submit" value="login" class="registerBtn" name="btnLogin">
   ...
   <div class="loginForm forgetpassword_form" style="<?php echo ((isset($post_set['type']) && !empty($post_set['type']) && trim($post_set['type'])=='forgetpass') ? 'display:block' : ((isset($post_set['type']) && !empty($post_set['type']) && trim($post_set['type'])=='login') ? 'display:none': 'display:none')); ?>" >
	   <form action="<?php echo base_url().'dance/studentforgetpassword'?>" method="post" id="frmLogin">
		   <ul>
				<li>
