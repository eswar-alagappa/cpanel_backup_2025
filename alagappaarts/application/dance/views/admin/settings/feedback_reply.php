                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>dance/admin/settings/feedback/reply<?php echo $urlArg; ?>" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
												...
												<a href="<?php echo base_url(); ?>dance/admin/settings/feedback" class="btn btn-primary" onclick="return confirm('Are you sure you want to leave this page?');"> Cancel </a>
