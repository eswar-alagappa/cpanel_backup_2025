...
<div class="right_col" role="main">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>dance/admin/master/fees/update<?php echo $urlArg; ?>" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
		...
		<div class="form-group col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="select_course form-control" name="course[<?php echo $i?>][]" id="p_<?php echo $i?>_course" multiple="multiple" style="height:60px">
