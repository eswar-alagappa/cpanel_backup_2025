                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
								...
								<div class="x_content">
									<!--<a class="btn btn-primary" href="<?php echo base_url().'dance/admin/students/add'; ?>">Add</a>-->
								</div>
								...
								<!--<form id="frmStudentsearch" method="post" action="<?php echo base_url().'dance/admin/students/index' ?>">
								<table border="0" cellpadding="5" cellspacing="5">
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <tbody>
										<?php if( !empty($listData)){ krsort($listData);//echo '<pre>';print_r($listData);
                                            ...
                                            <tr class="even pointer">												
												...
												<td class=" "><?php echo $list->mobileno ?> </td>
                                                <!--<td class=" "></td>-->
												...
												echo ' <a alt="View" title="View" href="'.base_url().'dance/admin/students/new_view/'.$list->new_student_id .'"><i class="fa fa-search"></i></a> | ';
												
												echo ' <a alt="Update" title="Update" href="'.base_url().'dance/admin/students/new_update/'.$list->new_student_id .'"><i class="fa fa-edit"></i></a> | ';
												
												echo ' <a alt="Remove" title="Remove" onclick="return confirm(\'Are you sure you want to delete?\');" href="'.base_url().'dance/admin/students/new_remove/'.$list->new_student_id.'"><i class="fa fa-trash"></i></a>';
												?>
                                                </td>												
                                            </tr>
                                            <?php } } ?>
