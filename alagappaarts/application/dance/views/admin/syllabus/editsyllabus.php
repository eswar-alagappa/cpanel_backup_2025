                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="" name="" method="POST" action="<?php echo base_url()?>dance/admin/syllabus/updatesyllabus<?php echo $urlArg;?>" class="form-horizontal form-label-left"  enctype='multipart/form-data'>
                                    
									
                                       
                                       <span class="section">Update syllabus Info</span>
										
										<div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Select Program <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <select readonly class="form-control col-md-7 col-xs-12" name="program_id" id="program_id">
													<option value="">Select Program</option>
													<?php if(!empty($programList)) { foreach($programList as $k=>$program){?>
														<option value="<?php echo $program->program_id; ?>" <?php echo ((isset($post_set['program_id']) && !empty($post_set['program_id'])  && ($post_set['program_id']== $program->program_id)) ? 'selected' : (isset($selectedValues->program_id) && !empty($selectedValues->program_id)  && ($selectedValues->program_id== $program->program_id) ? 'selected' : ''));?>><?php echo $program->name; ?></option>
													<?php } } ?>
											   </select>
                                        ...
                                        <div class="item form-group ">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 field_wrapper">
                                                <input type="text" name="video_title"  class="form-control col-md-7 col-xs-12" placeholder="Enter Video Url title" title="Enter Video Url Title" value="<?php echo $selectedValues->video_title ?>"/>
                                                 <?php echo form_error('video_title'); ?>
                                                 
                                                <input type="text" name="video_url"  class="form-control col-md-7 col-xs-12" placeholder="Enter Video Url" title="Enter Video Url" value="<?php echo $selectedValues->path ?>"/>
                                               <?php echo form_error('video_url'); ?>
                                               
                                               <textarea id="video_desc" name="video_desc" class="form-control col-md-7 col-xs-12" placeholder="Video Description"><?php echo $selectedValues->video_desc ?></textarea>
												<?php echo form_error('video_desc[]'); ?>
                                            </div>
                                            
                                        </div>
                                         <?php } ?>
                                        <input type="hidden" name='type'  placeholder="" value="<?php echo $selectedValues->type ?>" class="form-control name_list col-md-7 col-xs-12"  />
                                         <?php 
                                        if( $selectedValues->type == 'Pdf'){
                                        ?>
                                        ...
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Select PDF file<span class="required">*</span></label>
                                            ...
                                            <tr>
                                                 <td><label><?php echo $selectedValues->path ?></label></td>
                                            </tr>
                                                <tr>  
                                                   
                                                    <td>
                                                        <input type="text" name="pdf_title"  class="form-control col-md-7 col-xs-12" placeholder="Enter Pdf file title" title="Enter Pdf file Title" value="<?php echo $selectedValues->pdf_title ?>"/>
                                                    </td>
                                                    ...
                                                    <input type="hidden" name='hiddenfiles'  placeholder="" value="<?php echo $selectedValues->path ?>" class="form-control name_list col-md-7 col-xs-12"  />
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <textarea id="syllabus_content" required="required" placeholder="Syllabus Content" name="syllabus_content" class="form-control col-md-7 col-xs-12"><?php echo (isset($selectedValues->syllabus_content) && !empty($selectedValues->syllabus_content) ? $selectedValues->syllabus_content : '');?></textarea>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <textarea id="key_aspects" required="required" placeholder="Key Aspects" name="key_aspects" class="form-control col-md-7 col-xs-12"><?php echo (isset($selectedValues->key_aspects) && !empty($selectedValues->key_aspects) ? $selectedValues->key_aspects : '');?></textarea>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <textarea id="guidelines" required="required" placeholder="Guidelines" name="guidelines" class="form-control col-md-7 col-xs-12"><?php echo (isset($selectedValues->guidelines) && !empty($selectedValues->guidelines) ? $selectedValues->guidelines : '');?></textarea>
...
button.Zebra_DatePicker_Icon_Inside{margin:0 3px 0 0}
  ...
  <script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
    ...
    var i=1;  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="file" name="files[]" accept="application/pdf" placeholder="Enter your Name" class="form-control name_list col-md-7 col-xs-12" required /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });
