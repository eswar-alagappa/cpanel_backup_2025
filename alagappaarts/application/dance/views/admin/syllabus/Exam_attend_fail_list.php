                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Exam Attend Fail<small>list</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <tbody>
										<?php if( isset($failed_list) && !empty($failed_list))
										{ //echo '<pre>';print_r($listData);
														foreach($failed_list as $key=> $list)
														{
												?>
                                            <tr class="even pointer">												
												
												<td ><?php $phpdate = strtotime( $list['exam_startdate'] );
												...
												<td><?php if(!empty($list['error_report'])) { echo $list['error_report']; } else { echo 'Browser Closed or Internet Connection Failed'; } ?></td>
                                                <!--<td class=" "></td>-->
