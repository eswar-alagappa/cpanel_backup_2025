                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
								...
								<div class="x_content">
									<a class="btn btn-primary" href="<?php echo base_url().'dance/admin/syllabus/add'; ?>">Add</a>
								</div>
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
										...
										<?php if( !empty($listData)){ krsort($listData);//echo '<pre>';print_r($listData);
                                            ...
                                            <tr class="even pointer">												
												...
												echo ' <a alt="View" title="View" href="'.base_url().'dance/admin/syllabus/view/'.$list->user_id.'"><i class="fa fa-search"></i></a> | ';
												
												echo ' <a alt="Update" title="Update" href="'.base_url().'dance/admin/syllabus/update/'.$list->user_id.'"><i class="fa fa-edit"></i></a> | ';
