...
$assignedids=array();
if( isset($assigned_questions) && !empty($assigned_questions)){
...
<a href="<?php echo site_url('dance/admin/qbank/edit_question/'.$row->qid.'/'.$row->q_type );?>" target="edit_question" class="btn btn-info btn-xs">Edit</a>
...
<a href="javascript:questionselection('<?php echo $quid;?>','<?php echo $quiz_name;?>','<?php echo $back;?>','<?php echo $fcid;?>','<?php echo $course_id;?>');" class="btn btn-primary">Back</a>
&nbsp;&nbsp;
<?php
 $next=$limit+($this->config->item('number_of_rows'));  ?>

<a href="javascript:questionselection('<?php echo $quid;?>','<?php echo $quiz_name;?>','<?php echo $next;?>','<?php echo $fcid;?>','<?php echo $course_id;?>');"   class="btn btn-primary">Next</a>&nbsp;&nbsp;
