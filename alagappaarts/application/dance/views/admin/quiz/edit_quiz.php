...
window.location="<?php echo site_url();?>/dance/admin/qbank/index/0/"+cid;
}
	</script>
...
<form method="post" action="<?php echo site_url('dance/admin/quiz/edit_quiz/'.$result->quid);?>">
...
<td data-th="Action"><a href="<?php echo site_url('dance/admin/qbank/edit_question/'.$row->qid.'/'.$row->q_type );?>" class="btn btn-info btn-xs"  target="edit_question">Edit</a>
<a href="<?php echo site_url('dance/admin/quiz/remove_question_quiz/'.$result->quid.'/'.$row->qid );?>"  class="btn btn-danger btn-xs">Remove from Quiz</a>
<?php if($key!="0"){ ?>
...
window.location="<?php echo site_url('dance/admin/quiz/up_question');?>/"+global_quid+"/"+global_qid+"/"+npos;
}else{
var npos=parseInt(pos)-parseInt(global_opos);
window.location="<?php echo site_url('dance/admin/quiz/down_question');?>/"+global_quid+"/"+global_qid+"/"+npos;
}
}
</script>
