...
<form action="<?php echo site_url('dance/admin/quiz/submit_quiz/'.$quiz_id);?>" method="post" id="testform" onsubmit="showquestion('0');">
<?php 
$category_number=0;
...
window.location="<?php echo site_url();?>dance/admin/quiz/close_practice/";
}
