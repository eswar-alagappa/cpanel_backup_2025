                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <form method="post" action="<?php echo site_url('dance/admin/qbank/add_new/5');?>">
...
<input name="option[]" value="<?php echo ((isset($post_set['option']) && !empty($post_set['option'][0])) ? $post_set['option'][0] : '') ?>" type="text"> Ex: option1=Answer1</td></tr>
<tr><td valign="top" style="height:30px;">2) &nbsp;&nbsp;</td><td valign="top">
<input name="option[]" value="<?php echo ((isset($post_set['option']) && !empty($post_set['option'][1])) ? $post_set['option'][1] : '') ?>" type="text"> Ex: option2=Answer2</td></tr>
<tr><td valign="top" style="height:30px;" >3) &nbsp;&nbsp;</td><td valign="top">
<input name="option[]" value="<?php echo ((isset($post_set['option']) && !empty($post_set['option'][2])) ? $post_set['option'][2] : '') ?>" type="text"> Ex: option3=Answer3</td></tr>
<tr><td valign="top" style="height:30px;">4)  &nbsp;&nbsp; </td><td valign="top">
<input name="option[]" value="<?php echo ((isset($post_set['option']) && !empty($post_set['option'][3])) ? $post_set['option'][3] : '') ?>" type="text"> Ex: option4=Answer4 <?php $op="5"; ?></td></tr>
...
for($j=1; $j<=$add; $j++){ 
?>
<tr><td valign="top" style="height:30px;"><?php echo $op.")"; ?> &nbsp;&nbsp;</td><td valign="top"><input name="option[]" value="<?php echo ((isset($post_set['option']) && !empty($post_set['option'][($op-1)])) ? $post_set['option'][($op-1)] : '') ?>" type="text">  </td></tr>
<?php
$op++;
}
}
