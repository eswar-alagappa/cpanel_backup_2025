                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                   <form method="post" action="<?php echo site_url('dance/admin/qbank/add_new');?>">
...
<textarea name="option[]"><?php echo ((isset($post_set['option']) && !empty($post_set['option'][0]) && $post_set['score']==0) ? $post_set['option'][0] : ''); ?></textarea> </td></tr>
...
<textarea name="option[]"><?php echo ((isset($post_set['option']) && !empty($post_set['option'][1]) && $post_set['score']==1) ? $post_set['option'][1] : ''); ?></textarea> </td></tr>
...
<textarea name="option[]"><?php echo ((isset($post_set['option']) && !empty($post_set['option'][2]) && $post_set['score']==2) ? $post_set['option'][2] : ''); ?></textarea> </td></tr>
<tr><td valign="top">4)  &nbsp;&nbsp; <input type="radio" id="radiobtn" value="3" <?php echo (( isset($post_set['score']) && $post_set['score']==3) ? 'checked' : ''); ?> name="score"><?php $op="5"; ?></td><td valign="top">
<textarea name="option[]"><?php echo ((isset($post_set['option']) && !empty($post_set['option'][3]) && $post_set['score']==3) ? $post_set['option'][3] : ''); ?></textarea> </td></tr>
...
for($j=1; $j<= $add; $j++){ 
?>
<tr><td valign="top"><?php echo $op.")"; ?> &nbsp;&nbsp; <input type="radio" id="radiobtn" value="<?php echo $op-1; ?>" <?php echo (( isset($post_set['score']) && $post_set['score']==($op-1)) ? 'checked' : ''); ?> name="score"></td><td valign="top"><textarea name="option[]"><?php echo ((isset($post_set['option']) && !empty($post_set['option'][($op-1)]) && ($op-1)== $post_set['score'] ) ? $post_set['option'][($op-1)] : ''); ?></textarea>  </td></tr>
<?php
$op++;
}
}
