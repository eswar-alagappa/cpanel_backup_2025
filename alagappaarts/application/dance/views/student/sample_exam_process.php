...
<form action="<?php echo site_url('dance/student/submit_quiz/'.$quiz_id);?>" method="post" id="testform" onsubmit="showquestion('0');">
<?php 
$category_number=0;
...
var forbiddenKeys = new Array('a', 'n', 'c', 'x', 'v', 'j' , 'w' , 'r');
var key;
var isCtrl;
if(window.event)
{
