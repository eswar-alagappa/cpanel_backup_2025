...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Curriculum - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
	...
	<section class=" space-top">
        <div class="container">
            <div class="row justify-content-between flex-row-reverse gx-50">
                <div class="col-lg-6">
                    <div class="img-box7">
                        <div class="mega-hover"><img class="w-100" src="assets/img/about/Curriculum.jpg" alt="teacher">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <div class="service-about">
                        <h2 class="service-title h1 mt-n2">Curriculum Overview</h2>
                        <div class="title-divider2"></div>
                        <p class="service-text">Std L.K.G to XII is available</p>
                        <p class="service-text">Part II Language: English (compulsory)</p>
                        <p class="service-text">For Std. XI and XII Std, seven optional groups are offered Viz,</p>
                        <div class="list-style1">
                            <ul class="list-unstyled">
                                <li>Physics/Chemistry/Computer Science/Mathematics</li>
                                <li>Physics/Chemistry/Biology/Mathematics</li>
                                <li>Physics/Chemistry/Biology/Computer Science</li>
                                <li>Computer Application/Economics/Commerce/Accountancy</li>
                                <li>Economics/Commerce/Accountancy/Business Mathematics</li>
                            </ul>
                        </div>
						
			  <p class="service-text">For all the the above combinations Part, language is Tamil/Hindi/Sanskrit</p>
			  <p class="service-text">Samacheer Syllabus is followed upto Std X and State Syllabus is followed for +1 and +2(subject to State Government Orders) Board Public Examinations are conducted for X,XI,XII Standard.</p>
