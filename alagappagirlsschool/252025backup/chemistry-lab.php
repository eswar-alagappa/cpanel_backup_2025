...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Chemistry Lab - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Chemistry Lab</h1>
        ...
        <div class="about-style5">
            <div class="container-style4">
                <div class="title-area-four about5 text-center">
                    ...
                    <h3>The World of Reactions</span></h3>
                    <span class="sub-title">Dive into the world of chemical reactions, bonds, and compounds to understand the building blocks of matter.</span>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-content5">
                            <h4 class="title">Chemistry Lab</h4>
                            <p>Our chemistry lab is a state-of-the-art facility where students can explore the fascinating world of chemistry. With a focus on safety and hands-on learning, our lab is equipped with modern equipment and technology to support innovative teaching and learning.
                            </p>
<!--
...
-->
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-img5">
                            <img src="assets/img/campustour/chemistry/1.jpeg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/chemistry/2.jpeg" alt="gallery">
                            <a href="assets/img/campustour/chemistry/2.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/chemistry/3.jpeg" alt="gallery">
                            <a href="assets/img/campustour/chemistry/3.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/chemistry/4.jpeg" alt="gallery">
                            <a href="assets/img/campustour/chemistry/4.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
<!--
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            ...
                            <a href="assets/img/gallery/gal-3-5.jpg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
-->
