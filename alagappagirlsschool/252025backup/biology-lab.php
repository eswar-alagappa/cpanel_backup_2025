...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Biology Lab - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Biology Lab</h1>
        ...
        <div class="about-style5">
            <div class="container-style4">
                <div class="title-area-four about5 text-center">
                    ...
                    <h3>Unveiling the Mysteries of Life</span></h3>
                    <span class="sub-title">Engage with hands-on experiments to explore the cellular, genetic, and ecological wonders of the living world.</span>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-content5">
                            <h4 class="title">Biology Lab</h4>
                            <p>Our Biology Laboratory is a state-of-the-art facility designed to provide students with a comprehensive and engaging learning experience in the life sciences. Equipped with modern tools and resources, the lab supports hands-on experimentation, detailed observation, and in-depth study of biological concepts.
                            </p>
<!--
                            <ul class="about-list5">
...
-->
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-img5">
                            <img src="assets/img/campustour/key storke 1.jpeg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/key storke 1.jpeg" alt="gallery">
                            <a href="assets/img/campustour/key storke 1.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
-->
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/key storke 2.jpeg" alt="gallery">
                            <a href="assets/img/campustour/key storke 2.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/key storke 3.jpeg" alt="gallery">
                            <a href="assets/img/campustour/key storke 3.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/key storke 4.jpeg" alt="gallery">
                            <a href="assets/img/campustour/key storke 4.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
<!--
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            ...
                            <a href="assets/img/gallery/gal-3-4.jpg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
-->
                ...
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            ...
                            <a href="assets/img/gallery/gal-3-6.jpg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
-->
