...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Christmas Program - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h3 class="breadcumb-title">Christmas Program</h3>
...
<!--                                <span><i class="far fa-comment-alt-dots"></i>15</span>-->
                            ...
                            <h2 class="blog-title">Christmas Program Celebration</h2>
                     
                            <p class="mb-30">Join us as we celebrate the joy and wonder of the holiday season with an unforgettable Christmas Program featuring our talented students and staff. This year’s program is filled with festive performances, music, and holiday cheer designed to bring our community together.</p>
							       <h4>Get Involved</h4>
                                ...
                                <div class="col-xl">
                                    ...
                                    <div class="list-style1">
                                        <ul class="list-unstyled">
                                            <li>Seasonal Music Performances: Enjoy traditional carols and modern holiday classics performed by the school choir and band.</li>
                                            <li>Drama Presentation: A heartwarming holiday play brought to life by our theater students.</li>
                                            <li>Dance Performances: Enthralling routines by our dance team capturing the spirit of Christmas.</li>
                                            <li>Special Guest Appearance: A surprise visit from Santa Claus himself!</li>
