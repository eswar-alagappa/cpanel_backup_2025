...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Class Room - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Class Room</h1>
        ...
        <div class="about-style5">
            <div class="container-style4">
                <div class="title-area-four about5 text-center">
                    ...
                    <h3>Classroom: The Heart of Learning</span></h3>
                    <span class="sub-title">A dynamic space where theory meets practice, fostering curiosity and academic growth.</span>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-content5">
                            <h4 class="title">Who We Are</h4>
                            <p>At Alagappa Girls Matriculation Higher Secondary School, our classrooms are not just spaces for academic instruction—they're vibrant hubs of creativity, collaboration, and inspiration. Guided by dedicated teachers, students explore knowledge, embrace challenges, and build memories that last a lifetime. Here's a glimpse of the magic happening every day!
                            </p>
<!--
...
-->
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-img5">
                            <img src="assets/img/campustour/class/1.jpeg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            ...
                            <a href="assets/img/gallery/gal-3-1.jpg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            ...
                            <a href="assets/img/gallery/gal-3-2.jpg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            ...
                            <a href="assets/img/gallery/gal-3-3.jpg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
