...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Computer Lab - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Computer Lab</h1>
        ...
        <div class="about-style5">
            <div class="container-style4">
                <div class="title-area-four about5 text-center">
                    ...
                    <h3>Innovating with Technology</span></h3>
                    <span class="sub-title">Explore the digital world through coding, simulations, and cutting-edge technologies to prepare for the future.</span>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-content5">
                            <h4 class="title">Computer Lab</h4>
                            <p>Our computer lab facilities aim to equip students with the skills and knowledge necessary to succeed in an increasingly digital world, preparing them for future studies and careers in computer science and technology.
                            </p>
<!--
...
-->
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-img5">
                            <img src="assets/img/campustour/computer/1.jpeg" alt="">
                        </div>
                    </div>
                </div>
            </div>
