...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Admission - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
...
<!--                <p class="breadcumb-text">Montessori Is A Nurturing And Holistic Approach To Learning</p>-->
    ...
    Contact Area
    ==============================-->
        <section class="git-layout1 z-index-common space-top space-extra-bottom overflow-hidden">
<!--        <img src="assets/img/git/git-8-4.svg" alt="" class="git-ele1">-->
<!--        <img src="assets/img/git/git-8-3.png" alt="" class="git-ele2">-->
        <div class="git-bg-shape"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-7 mb-30">
                    <div class="title-area">
<!--                        <span class="sec-subtitle">GET IN TOUCH</span>-->
                        <h2 class="sec-title">Admission Procedures!</h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-10">
                            <p>Admission will be made as per regulations established by the State Govt.of Tamilnadu. A student seeking admission into any class should produce the following original certificates.</p>
                        </div>
                    </div>
                    <div class="list-style1 v3">
                        <ul class="list-unstyled">
                            <li>Valid Transfer Certificate(T.C) from the previous school with EMIS NO</li>
                            <li>Birth Certificate</li>
                            <li>Community Certificate</li>
                            <li>Aadhaar card</li>
                        </ul>
                    </div>
					                        <img src="assets/img/admission_poster.jpg" alt="git" class="img1">

					
					<div id="wrap">
<a href="admission-form-VI-to-X-std.docx" class="btn-slide">
    
  <span class="circle"><i class="fa fa-download"></i></span>
  <span class="title">LKG-X STD</span>
  <span class="title-hover">Download</span>
</a>
						<a href="admission-form-XI-std.docx" class="btn-slide">
  <span class="circle"><i class="fa fa-download"></i></span>
  <span class="title">XI STD</span>
  <span class="title-hover">Download</span>
</a>
<!--
<a href="admission-form-XI-std.docx" class="btn-slide2">
  <span class="circle2"><i class="fa fa-download"></i></span>
  <span class="title2">Download</span>ch
...
-->
                    ...
                    <div class="img-box12">
                        <!--<img src="assets/img/about/admission1.jpeg" alt="git" class="img1">-->
                        <!--<img src="assets/img/about/admission2.png" alt="git" class="img2">-->
<!--
                        <div class="select-icon-card">
                            <img src="assets/img/others/se-icon-8-1.svg" alt="icon" class="icon-img">
...
-->
                ...
                <div class="col-lg-5 mb-30">
                    <form action="mail.php" method="post" class="form-style3 layout3 ajax-contact" data-bg-src="assets/img/git/git-form-bg.png">
    <span class="sec-subtitle text-white">Enroll NOW</span>
    <h2 class="sec-title text-white">Apply For Admission</h2>
    <div class="row justify-content-between">
        <div class="col-md-12 form-group">
            <input name="firstname" id="firstname" type="text" placeholder="Child's Name (Required)" required>
        </div>
        <div class="col-md-12 form-group">
            <input name="lastname" id="lastname" type="text" placeholder="Child's DOB (Required)" required>
        </div>
        <div class="col-md-12 form-group">
            <input name="email" id="email" type="email" placeholder="Email Address" required>
        </div>
        <div class="col-md-12 form-group">
            <input name="number" id="number" type="text" placeholder="Location" required>
        </div>
        <div class="col-12 form-group">
            <textarea name="message" id="message" cols="30" rows="10" placeholder="How can we help you?" required></textarea>
        </div>
        <div class="col-auto form-group">
            <button class="vs-btn style2" type="submit">Apply Now</button>
        </div>
    </div>
