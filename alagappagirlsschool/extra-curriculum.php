...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Extra Curriculum - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Extra Curriculum</h1>
...
<!--			                    <h2 class="lession-title h1">Extra Curriculum</h2>-->
			<div class="title-area-four about5 text-center">
                    <img src="assets/img/breadcumb/title-img.png" alt="">
                    <h3>Extra Curriculum</span></h3>
<!--                    <span class="sub-title"><span>Chairman & Correspondent</span> </span>-->
                </div>

            <div class="img-box7 mb-lg-5">
                <div class="mega-hover"><img src="assets/img/Curriculum.jpg" alt="class"></div>
            </div>
            
            
<!--            <h2>Overview</h2>-->
<!--            <div class="title-divider1"></div>-->
            <p>Our school offers a range of Extracurricular Activities (ECAs) that cater to diverse interests and talents. Among these, Silambam, Karate, and Yoga have gained immense popularity among our students. These ancient practices not only foster physical discipline but also cultivate mental focus, self-awareness, and inner peace.</p>
            ...
            <div class="row">
                <div class="col-md-6 mt-4">
                    <div class="img-box7 mb-0">
                        <div class="mega-hover"><img src="assets/img/Curriculum2.jpg" alt="class"></div>
                    </div>
                </div>
                <div class="col-md-6 mt-4">
                    <div class="img-box7">
                        <div class="mega-hover"><img src="assets/img/Curriculum3.jpg" alt="class"></div>
                    </div>
                </div>
            </div>
