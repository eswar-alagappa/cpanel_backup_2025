...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Manuscript - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Manuscript</h1>
                ...
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/m1.jpeg" alt="gallery">
                            <a href="assets/img/gallery/m1.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/m2.jpeg" alt="gallery">
                            <a href="assets/img/gallery/m2.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/m3.jpeg" alt="gallery">
                            <a href="assets/img/gallery/m3.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/m4.jpeg" alt="gallery">
                            <a href="assets/img/gallery/m4.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/m5.jpeg" alt="gallery">
                            <a href="assets/img/gallery/m5.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/m6.jpeg" alt="gallery">
                            <a href="assets/img/gallery/m6.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
