...
<title>New Year - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h3 class="breadcumb-title">New Year Program</h3>
                ...
                <div class="col-lg-12">
                    <div class="vs-blog blog-single">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.html"><i class="far fa-calendar-alt"></i>January 2, 2026</a>
<!--                                <span><i class="far fa-comment-alt-dots"></i>15</span>-->
                            </div>
                            <h2 class="blog-title">New Year Celebration 2026
</h2>
                     
                            <p class="mb-30">🎉 Welcome the New Year with Joy and Celebration! 🎉<br>

Our school community is excited to ring in the New Year with a vibrant and fun-filled celebration! Join us as we reflect on the past year, embrace new beginnings, and create wonderful memories together.</h4>
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-auto">
                                    <div class="mb-30 mega-hover"><img src="assets/img/events/.jpg" height="auto" width="500px" alt="blog"></div>
                                </div>
                            </div>
							
<!--							  <h4>Program Highlights</h4>-->
<!--                            <p class="mb-30">We welcome parents, friends, and the community to join us for this special occasion. Don’t miss the chance to see the incredible talents of our students and celebrate the season with joy and togetherness.</p>-->
<!--
