...
<!--                        <p class="class-info">Required: <span class="info">2 - 6 Years</span></p>-->
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="class-style2">
                        ...
                        <div class="class-img">
                            <div class="img"><a href="class-details.html"><img src="assets/img/academic/2.png" alt="class"></a></div>
...
<!--                        <p class="class-info">Required: <span class="info">2 - 6 Years</span></p>-->
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="class-style2">
                        ...
                        <div class="class-img">
                            <div class="img"><a href="class-details.html"><img src="assets/img/academic/3.png" alt="class"></a></div>
...
<!--                        <p class="class-info">Required: <span class="info">2 - 6 Years</span></p>-->
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="class-style2">
                        ...
                        <div class="class-img">
                            <div class="img"><a href="class-details.html"><img src="assets/img/academic/5.png" alt="class"></a></div>
...
<!--                        <p class="class-info">Required: <span class="info">2 - 6 Years</span></p>-->
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="class-style2">
                        ...
                        <div class="class-img">
                            <div class="img"><a href="class-details.html"><img src="assets/img/academic/6.png" alt="class"></a></div>
                            <span class="class-number">06</span>
                        </div>
                         <p class="class-info">D.Priyadharshini </p>
<!--                        <p class="class-info">Required: <span class="info">2 - 6 Years</span></p>-->
                        <h3 class="class-title h5">582/500</h3>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="class-style2">
                        ...
                        <div class="class-img">
                            <div class="img"><a href="class-details.html"><img src="assets/img/academic/7.png" alt="class"></a></div>
...
<!--                        <p class="class-info">Required: <span class="info">2 - 6 Years</span></p>-->
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="class-style2">
                        ...
                        <div class="class-img">
                            <div class="img"><a href="class-details.html"><img src="assets/img/academic/8.png" alt="class"></a></div>
