    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h3 class="breadcumb-title">International Yoga Day</h3>
            ...
            <div class="row gx-40">
                <div class="col-lg-12">
                    <div class="vs-blog blog-single">
                        <div class="blog-img">
                            <img src="/assets/img/events/yoga/yoga.jpeg" alt="Blog Image">
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.html"><i class="far fa-calendar-alt"></i>June 21, 2025</a>
<!--                                <span><i class="far fa-comment-alt-dots"></i>15</span>-->
                            </div>
                            <h2 class="blog-title">International Yoga Day 2025

</h2>

<br>

Alagappa Girls School is gearing up to celebrate International Yoga Day on June 21, 2025, with great enthusiasm.</h4>
                            <div class="row align-items-center">
								
                                <div class="col-xl">
   <li>
      <p><strong>Alagappa Girls School is gearing up to celebrate International Yoga Day on June 21, 2025, with great enthusiasm.

Students and staff are preparing a vibrant program highlighting the benefits of yoga for mind and body.

The event aims to promote wellness, unity, and healthy living through traditional yoga practices.
</strong>:</p>
      <ul>
   ...
   <li>
                                ...
                                <div class="col-xl-auto">
                                    <div class="mb-30 mega-hover"><img src="/assets/img/events/yoga/Yoga2.png" height="auto" width="500px" alt="blog"></div>
                                </div>
                            </div>
