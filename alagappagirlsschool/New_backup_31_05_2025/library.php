...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Library - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Library</h1>
        ...
        <div class="about-style5">
            <div class="container-style4">
                <div class="title-area-four about5 text-center">
                    ...
                    <h3>The Gateway to Knowledge</span></h3>
                    <span class="sub-title">A vast collection of resources and books to fuel imagination, research, and lifelong learning.</span>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-content5">
                            <h4 class="title">Library</h4>
                            <p>Our school library is a cornerstone of our educational environment, designed to inspire a love for reading and support academic success. With its welcoming atmosphere and extensive resources, the library serves as a hub for learning, research, and creative exploration.
                            </p>
<!--
...
-->
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-img5">
                            <img src="assets/img/campustour/lib/1.jpeg" alt="">
                        </div>
                    </div>
                </div>
            </div>
