...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>About us - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
	...
	<section class=" space-top">
        <div class="container">
            <div class="row justify-content-between flex-row-reverse gx-50">
                <div class="col-lg-6">
                    <div class="img-box7">
                        <div class="mega-hover"><img class="w-100" src="assets/img/dr_alagappachettiar.jpg" alt="teacher">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <div class="service-about">
<!--                        <h2 class="service-title h1 mt-n2">Founder: <span>Dr. Alagappa Chettiar Educational Trust Asoka Charitable Trust</span></h2>-->
						
						<div class="col-md-5 col-lg-12">
                    <h3 class="h4">Founder</h3>
<!--                    <div class="title-divider1"></div>-->
                    <h4 class="text-theme mt-n2">Late Dr. Alagappa Chettiar</h4><h5>Educational Trust Asoka Charitable Trust</h5>
<!--
                    <p class="fs-md">Phone : <a href="tel:+0987654321" class="text-inherit">+098 765 4321</a> <br>
                        Email: <a href="mailto:contact@zoutula.com" class="text-inherit">contact@zoutula.com</a></p>
-->
                </div>
...
.service-text{
    font-size: 21px;
						...
						<div class="quote-bubble" align="justify"><strong>"My happiness knows no bounds—not because it lies in my own joy, but because it lives
in the smiles of thousands of students, young and old, who have been educated on our
vast campus." </strong></br></br>
<p>- From the final speech of Dr. R.M. Alagappa Chettiar, March 1957</p></div>
</br>
						
			  <p class="service-text" align="justify">Dr. R.M. Alagappa Chettiar was a visionary who believed that education is essential to
building a productive, compassionate, and complete human being. At the dawn of India's
independence, he responded to the Prime Minister's call by establishing an Arts College in
Karaikudi. His generous contributions laid the foundation for a network of educational
institutions, ultimately leading to the creation of Alagappa University in 1985.</p>

<p class="service-text" align="justify">

Dr. Chettiar’s donation of 300 acres of land and ₹15 lakhs also paved the way for the
Government of India to establish the Central Electrochemical Research Institute in Karaikudi.
In just two decades, he transformed a barren landscape into a thriving educational
hub—leaving behind a legacy as an industrialist, philanthropist, and educationist who
reshaped the future of his hometown.
</p>
	...
	<section class=" space-top">
        <div class="container">
            <div class="row justify-content-between flex-row-reverse gx-50">
                <div class="col-lg-6">
                    <div class="img-box7">
                        <div class="mega-hover"><img class="w-100" src="assets/img/umayalramanathan.jpg" alt="teacher">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
...
<!--                        <h2 class="service-title h1 mt-n2">Founder: <span>Dr. Alagappa Chettiar Educational Trust Asoka Charitable Trust</span></h2>-->
						...
						<div class="col-md-5 col-lg-12">
                    <h3 class="h4">Secretary Emeritus</h3>
<!--                    <div class="title-divider1"></div>-->
                    <h4 class="text-theme mt-n2">Late Dr. Umayal Ramanathan</h4><h5>Trustee Asoka Charitable Trust</h5>
<!--
                    <p class="fs-md">Phone : <a href="tel:+0987654321" class="text-inherit">+098 765 4321</a> <br>
                        Email: <a href="mailto:contact@zoutula.com" class="text-inherit">contact@zoutula.com</a></p>
-->
...
-->
			  ...
			  <p class="service-text" align="justify">A pioneering force in women’s empowerment, Dr.Umayal Ramanathan founded the
...
and actively lead several educational and charitable trusts.<br>Recognized for her service to society, she has received the Indira Gandhi
