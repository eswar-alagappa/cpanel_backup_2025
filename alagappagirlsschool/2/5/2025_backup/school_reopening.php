...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>School Reopening - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
...
<!--                                <span><i class="far fa-comment-alt-dots"></i>15</span>-->
                            ...
                            <h2 class="blog-title">School Reopening Announcement</h2>
                     
                            <p class="mb-30">
We are thrilled to announce the reopening of Alagappa Girls Matriculation Hr. Sec. School! After a refreshing break, we warmly welcome our students back to a vibrant and engaging academic environment. Our campus is ready, our teachers are prepared, and we are excited to continue the journey of learning and discovery.
</p>
...
<div class="row align-items-center">
    <div class="col-xl">
        <div class="list-style1">
            <ul class="list-unstyled">
                <li><strong>Reopening Date:</strong> Classes resume from June 10, 2025 for all grades.</li>
                <li><strong>Safety Protocols:</strong> Enhanced hygiene measures and thermal screening at entry points.</li>
                <li><strong>Class Timings:</strong> Regular school hours will be followed. Students must be punctual.</li>
                <li><strong>Uniform & Materials:</strong> Ensure students come in complete uniform with necessary supplies.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-xl-auto">
        <div class="mb-30 mega-hover">
            <img src="assets/img/reopening.jpg" height="auto" width="500px" alt="School Reopening">
        </div>
    </div>
</div>

<h4>Welcoming Our Students</h4>
<p class="mb-30">
Let us step into the new academic year with renewed energy and commitment. Our goal is to provide an inspiring, safe, and joyful learning experience. Together, let's make this year a memorable and productive one!
</p>
<!--
