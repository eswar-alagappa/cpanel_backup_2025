...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Mother's Day Celebration - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h3 class="breadcumb-title">Mother's Day Celebration</h3>
<!--                <p class="breadcumb-text">A heartwarming celebration of motherly love and talent!</p>-->
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        <li><a href="index.html">Home</a></li>
                        <li>Mother's Day Celebration</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row gx-40">
                <div class="col-lg-12">
                    <div class="vs-blog blog-single">
                        <div class="blog-img">
                            <img src="assets/img/mother/Mother2.jpeg" alt="Blog Image">
                        </div>
...
<!--                                <span><i class="far fa-comment-alt-dots"></i>15</span>-->
                            ...
                            <h2 class="blog-title">Mother's Day Celebration</h2>
                     
                            <p class="mb-30">A Heartwarming Celebration of Motherly Love and Talent!</p>
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl">
                                    ...
                                    <div class="list-style1">
                                        <ul class="list-unstyled">
                                            <li>To honor the unwavering love, strength, and creativity of mothers, Alagappa Girls School proudly organized a Mehandi Competition as part of our Mother’s Day celebrations. This special event provided a platform for mothers and ladies to showcase the artistic skills they learned during our vibrant Summer Camp.</li>
                                            <li>The atmosphere was filled with joy, laughter, and a deep sense of appreciation as participants displayed intricate and beautiful Mehandi designs, each telling its own story of love and heritage. It was more than just a competition—it was a celebration of motherhood and creativity.</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-auto">
                                    <div class="mb-30 mega-hover"><img src="assets/img/mother/Mother1.jpeg" height="auto" width="500px" alt="blog"></div>
                                </div>
                            </div>
                        </div>
