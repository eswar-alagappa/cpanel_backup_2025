...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>Academic Planning - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h3 class="breadcumb-title">Academic Planning</h3>
...
<!--                                <span><i class="far fa-comment-alt-dots"></i>15</span>-->
                            ...
                            <h2 class="blog-title">Academic Planning</h2>
                     
                            <p class="mb-30">
As we gear up for the academic year starting on <strong>June 10, 2025</strong>, Alagappa Girls Matriculation Hr. Sec. School is dedicated to creating a structured and inspiring learning environment. Our academic planning integrates innovative teaching, comprehensive curricula, and student-focused strategies to ensure success and growth at every level.
</p>

<h4>Planning Objectives</h4>
<div class="row align-items-center">
    <div class="col-xl">
        <div class="list-style1">
            <ul class="list-unstyled">
                <li><strong>Curriculum Roadmap:</strong> Well-defined academic modules for each subject across all standards.</li>
                <li><strong>Interactive Learning:</strong> Emphasis on technology-based and activity-driven classrooms.</li>
                <li><strong>Assessment Schedule:</strong> Term-wise tests, monthly reviews, and project-based evaluations.</li>
                <li><strong>Teacher Training:</strong> Workshops to enhance teaching methodologies and subject expertise.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-xl-auto">
        <div class="mb-30 mega-hover">
            <img src="assets/img/academic-planning.jpg" height="auto" width="500px" alt="Academic Planning">
        </div>
    </div>
</div>
...
<h4>Looking Ahead</h4>
<p class="mb-30">
Our planning ensures that every student receives quality education and support to thrive academically and personally. With structured schedules, teacher preparedness, and student enthusiasm, we are set for a remarkable academic year ahead.
</p>
