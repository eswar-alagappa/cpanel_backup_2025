...
<title>Physics lab - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Physics Lab</h1>
        ...
        <div class="about-style5">
            <div class="container-style4">
                <div class="title-area-four about5 text-center">
                    ...
                    <h3>Physics Lab: Understanding the Laws of Nature</span></h3>
                    <span class="sub-title">Experiment with forces, motion, and energy to uncover the fundamental principles that govern the universe.</span>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-content5">
                            <h4 class="title">Physics Lab</h4>
                            <p>Our school takes pride in its well-equipped physics lab, designed to provide students with a comprehensive and immersive learning experience. The lab is furnished with modern equipment and technology, enabling students to explore and experiment with various physics concepts.
                            </p>
<!--
...
-->
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-img5">
                            <img src="assets/img/campustour/phy/1.jpeg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/phy/2.jpeg" alt="gallery">
                            <a href="assets/img/campustour/phy/2.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/phy/3.jpeg" alt="gallery">
                            <a href="assets/img/campustour/phy/3.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/phy/4.jpeg" alt="gallery">
                            <a href="assets/img/campustour/phy/4.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/phy/5.jpeg" alt="gallery">
                            <a href="assets/img/campustour/phy/5.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 filter-item">
                    <div class="gallery-style1 layout2">
                        <div class="gallery-img">
                            <img src="assets/img/campustour/phy/6.jpeg" alt="gallery">
                            <a href="assets/img/campustour/phy/6.jpeg" class="gallery-btn popup-image"><i class="fal fa-plus"></i></a>
                        </div>
                    </div>
                </div>
