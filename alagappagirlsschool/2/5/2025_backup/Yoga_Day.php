...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>International Yoga Day - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
              ...
              <div class="col-lg-12">
                <div class="vs-blog blog-single">
                  ...
                  <div class="blog-content">
                    ...
                    <h2 class="blog-title">International Yoga Day 2025</h2>
        
                    <p><strong>Alagappa Girls School is gearing up to celebrate International Yoga Day on June 21, 2025, with great enthusiasm.</strong></p>
        
                    <p>Students and staff are preparing a vibrant program highlighting the benefits of yoga for mind and body.</p>
                    <p>The event aims to promote wellness, unity, and healthy living through traditional yoga practices.</p>
                    ...
                    <!--      <img src="/assets/img/events/yoga/Yoga2.png" alt="blog" style="width: 500px; height: auto;">-->
                    <!--    </div>-->
                    <!--  </div>-->
                    </div>
