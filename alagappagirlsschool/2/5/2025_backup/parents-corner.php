...
<title>Parents Corner - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Parents Corner</h1>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-10 col-xl-9">
                    <div class="title-area">
                        ...
                        <h2 class="sec-title">Parents Testimonials
</h2>
<!--
                        <p class="sec-text px-xxl-4">At Alagappa Girls Matriculation Higher Secondary School, we take pride in fostering a nurturing and inspiring environment for our students. The trust and appreciation of our parents are a testament to the values we uphold and the efforts we dedicate to their children’s growth.<br>

This section is a space to share the heartfelt experiences of our parents, who have witnessed the transformative journey of their daughters. From academic achievements to personal growth, their words reflect the bond of trust and partnership we share in shaping the future of our students.<br>

We invite you to explore these testimonials and gain insights into the vibrant learning community that defines our school.</p>
-->
                    </div>
                </div>
            </div>
            <div class="img-box4">
                <div class="img-1 mega-hover">
                    <img src="assets/img/parents_corner.jpg" alt="about">
                    <a href="https://www.youtube.com/watch?v=_XaVHDcK5lE" class="play-btn popup-video position-center"><i class="fas fa-play"></i></a>
                </div>
            </div>
        </div>
    </section>
