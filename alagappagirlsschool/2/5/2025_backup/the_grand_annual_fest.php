...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <meta http-equiv="x-ua-compatible" content="ie=edge">
<title>The Grand Annual Fest - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
            ...
            <div class="widget  ">
                ...
                <div class="recent-post-wrap">
                    ...
                    <div class="recent-post">
                        ...
                        <div class="media-body">
                            <div class="recent-post-meta">
                                <a href="new_year.php"><i class="far fa-calendar-alt"></i>December 23, 2025</a>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="vs-blog blog-single">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.html"><i class="far fa-calendar-alt"></i>December 23, 2025</a>
<!--                                <span><i class="far fa-comment-alt-dots"></i>15</span>-->
                            </div>
                            <h2 class="blog-title">The Grand Annual Fest</h2>
                     
                            <p class="mb-30">
Alagappa Girls Matriculation Hr. Sec. School proudly presents <strong>The Grand Annual Fest 2025</strong> — a vibrant celebration of talent, culture, and achievement. This much-anticipated event brings together students, faculty, and parents in a joyful showcase of academic, artistic, and athletic excellence.
</p>
    ...
    <div class="col-xl">
        <div class="list-style1">
            <ul class="list-unstyled">
                <li><strong>Student Performances:</strong> Enthralling music, dance, and drama performances by our talented students.</li>
                <li><strong>Awards Ceremony:</strong> Honoring academic achievers, sports champions, and extracurricular stars.</li>
                <li><strong>Exhibition Stalls:</strong> Creative projects, science models, and artistic exhibits by every grade.</li>
                <li><strong>Special Guests:</strong> Esteemed dignitaries and alumni share their insights and encouragement.</li>
            </ul>
        </div>
    </div>

    <div class="col-xl-auto">
        <div class="mb-30 mega-hover">
            <img src="assets/img/annualfest.jpg" height="auto" width="500px" alt="Annual Fest Celebration">
        </div>
    </div>
</div>

<h4>Together We Celebrate</h4>
<p class="mb-30">
The Grand Annual Fest reflects our school’s spirit of unity, creativity, and excellence. It’s more than a celebration — it’s a moment of pride and inspiration for our entire school community. Join us as we applaud the accomplishments of the past year and look forward to the journey ahead.
</p>
