...
<title>Play Field - Alagappa Girls Matriculation Hr. Sec School - Excellence in Education, Karaikudi</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/management.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Play Field</h1>
        ...
        <div class="about-style5">
            <div class="container-style4">
                <div class="title-area-four about5 text-center">
                    ...
                    <h3>Where Fun Meets Fitness</span></h3>
                    <span class="sub-title">An outdoor space designed to promote physical activity, teamwork, and healthy competition</span>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-content5">
                            <h4 class="title">Play Field</h4>
                            <p>Our school’s play field is a vibrant and dynamic space designed to foster physical activity, teamwork, and fun. Spanning over acres, the play field provides a safe and engaging environment for students to explore and enjoy a variety of outdoor activities.
                            </p>
<!--
...
-->
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-img5">
                            <img src="assets/img/campustour/play/1.jpeg" alt="">
                        </div>
                    </div>
                </div>
            </div>
