...
<!-- ./wrapper -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  ?>
	  <form method="post" action="<?php echo base_url().'admin/home/banners/'.$urlParam?>" enctype="multipart/form-data">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
			  ...
			  <input type="hidden" class="default" name="banner_photo" value="<?php echo ((isset($upload_data['file_name']) && !empty($upload_data['file_name'])) ? $upload_data['file_name'] : ( (isset($selected->imgPath) && !empty($selected->imgPath)) ? $selected->imgPath : ''))?>" id="old_photo">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  <td><?php echo (($res->type == 1) ? 'Home' : 'Inner Page')?></td>
                  <td><?php echo $res->name?></td>
				  <td><?php echo $res->title?></td>
				  <td><img width="100" height="100" src="<?php echo (($res->type == 1) ? base_url('/').'upload/slider/'.$res->imgPath : base_url('/').'upload/banner/'.$res->imgPath)  ?>"> </td>
                  <td>
				  <?php $id = $res->id;?>
				  <a href="<?php echo base_url()?>admin/home/banners/edit/<?php echo $id?>">Edit</a> |
				  <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url()?>admin/home/banners/delete/<?php echo $id?>">Delete</a>
				  </td>
                </tr>
