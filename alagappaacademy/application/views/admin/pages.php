...
<!-- ./wrapper -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  ?>
	  <form method="post" action="<?php echo base_url().'admin/home/pages/'.$urlParam?>">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $res->alias?></td>
                  <td>
				  <?php $id = $res->id;?>
				  <a href="<?php echo base_url()?>admin/home/pages/edit/<?php echo $id?>">Edit</a> |
				  <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url()?>admin/home/pages/delete/<?php echo $id?>">Delete</a>
				  </td>
                </tr>
