...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  ?>
	  <form method="post" action="<?php echo base_url().'home/admin'?>">
		...
		<div class="col-md-12">
			<div class="col-md-6">
				<div class="form-group">
				  <label>Title</label>
				  <input type="text" name="title" value="<?php echo set_value('title'); ?>" class="form-control" placeholder="Please enter title">
				</div>
			...
			<div class="col-md-6">
				<div class="form-group">
				  <label>Alias</label>
				  <input type="text" name="alias" value="<?php echo set_value('alias'); ?>" class="form-control" placeholder="Please enter Alias">
				</div>
