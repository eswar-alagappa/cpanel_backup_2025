...
$options[] = array(
	...
	'class' => 'header-layout-classic-settings',
	'type'  => 'block',
);
...
$options[] = array(
	...
	'class' => 'header-layout-inline-settings',
	'type'  => 'block',
);
...
$options[] = array(
	...
	'class' => 'header-layout-split-settings',
	'type'  => 'block',
);
...
$options[] = array(
	...
	'class' => 'header-layout-side-settings',
	'type'  => 'block',
);
...
$options[] = array(
	...
	'class' => 'header-layout-top_line-settings',
	'type'  => 'block',
);
...
$options[] = array(
	...
	'class' => 'header-layout-side_line-settings',
	'type'  => 'block',
);
...
$options[] = array(
	...
	'class' => 'header-layout-menu_icon-settings',
	'type'  => 'block',
);
...
$options['header-elements-search-icon'] = array(
	...
	'options'    => array(
		...
		'default'  => _x( 'Default', 'theme-options', 'the7mk2' ),
...
$options['header-elements-search_custom-icon-size'] = array(
	'id'         => 'header-elements-search_custom-icon-size',
...
$options['microwidgets-search_font-family'] = array(
	'id'    => 'microwidgets-search_font-family',
	'name'  => _x( 'Font family', 'theme-options', 'the7mk2' ),
	'type'  => 'web_fonts',
	'std'   => 'Roboto',
	'fonts' => 'all',
...
$options['microwidgets-search_font-size'] = array(
	'id'       => 'microwidgets-search_font-size',
	'name'     => _x( 'Font size', 'theme-options', 'the7mk2' ),
	'type'     => 'slider',
	'sanitize' => 'font_size',
	'std'      => 14,
...
$options[] = array( 'type' => 'js_hide_begin', 'class' => 'microwidgets-search_style popup-bg-show' );
$options[] = array( 'type' => 'divider', );

$options[] = array(
	'name' => _x( 'Popup background', 'theme-options', 'the7mk2' ),
	'type' => 'title',
);

$options['microwidgets-search_popup-bg-color'] = array(
	'name'       => _x( 'Choose color', 'theme-options', 'the7mk2' ),
	'type'       => 'alpha_color',
	'id'         => 'microwidgets-search_popup-bg-color',
...
$options[] = array(
	...
	'class' => 'header-classic-menu-bg-block',
	'type'  => 'block',
);
...
$options[] = array(
	'name'  => _x( 'Menu button appearance', 'theme-options', 'the7mk2' ),
...
$options[] = array(
	...
	'class' => 'submenu-for-side-headers-block',
	'type'  => 'block',
);
...
$options[] = array(
	'name'  => _x( 'Submenu & drop-down microwidgets background', 'theme-options', 'the7mk2' ),
	'class' => 'submenu-bg-block',
	'type'  => 'block',
);
...
// $options['header-floating_navigation-bg-is_fixed'] = array(
// 	'id'   => 'header-floating_navigation-bg-is_fixed',
// 	'name' => _x( 'Fixed background ', 'theme-options', 'the7mk2' ),
// 	'type' => 'checkbox',
// 	'std'  => 0,
// );
