    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
     ...
     <div class="xs tabls">
        <div class="bs-example4" data-example-id="contextual-table">
            <div class="x_content">
                <form method="post" name="form1" id="form1"  action="<?php echo site_url('/') . 'admin/examvenue/view'; ?>">
                ...
                <table class="table">
                    <thead>
                        <tr class="headings">
                            ...
                            <th class="column-title">Session Start</th>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="even pointer">
                                    ...
                                    <td class=" "><?php echo $row['session_start']; ?></td>
                                    <td class=" "><?php echo $row['address']; ?></td>
                                    <?php 
                                    if ($login_rolename != 'student' ) { 
                                    ?>
                                            <td class=" last text-center">
                                                <a href="<?php echo site_url('/') . 'admin/examvenue/edit/' . $eid; ?>">Edit</a> 
                                            </td>
                                            <td class="last text-center" style="cursor: pointer;">
                                                <a class="deleteRecord" href1="<?php echo site_url('/') . 'admin/examvenue/delete/' . $eid; ?>">Delete</a> 
                                            </td>
                                    <?php } ?>
                                </tr>
                        <?php
...
$(document).ready(function(){
    $("#btnAdd").click(function(){
        ...
        document.location.href = site_url + 'admin/examvenue/add';
    });
