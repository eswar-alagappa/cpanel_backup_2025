    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="dashboard_graph">
            ...
            <div class="row x_title">
                <div class="col-md-6">
                    <h3>Payment received List</small></h3>
                </div>
                <div class="col-md-6">
     ...
     <div class="xs tabls">
        <div class="bs-example4" data-example-id="contextual-table">
            <div class="x_content">
                <form method="post" name="form1" id="form1"  action="<?php echo site_url('/') . 'admin/payment/view'; ?>">
                                ...
                                <tr class="even pointer">
                                    ...
                                    ?>
                                            <td class=" last text-center">
                                                <a href="<?php echo site_url('/') . 'admin/payment/edit/' . $eid; ?>">Edit</a> 
                                            </td>
                                            <td class="last text-center" style="cursor: pointer;">
                                                <a class="deleteRecord" href1="<?php echo site_url('/') . 'admin/payment/delete/' . $eid; ?>">Delete</a> 
                                            </td>
                                    <?php } ?>
                                </tr>
                        <?php
...
$(document).ready(function(){
    $("#btnAdd").click(function(){
        ...
        document.location.href = site_url + 'admin/payment/add';
    });
