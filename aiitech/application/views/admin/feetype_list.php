...
<?php
$list = isset($listFeetype) ? $listFeetype : array();
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
     ...
     <div class="xs tabls">
        <div class="bs-example4" data-example-id="contextual-table">
            <div class="x_content">
                <form method="post" name="form1" id="form1"  action="<?php echo site_url('/') . 'admin/feetype/view'; ?>">
                                ...
                                <tr class="even pointer">
                                    ...
                                    ?>
                                            <td class=" last text-center">
                                                <a href="<?php echo site_url('/') . 'admin/feetype/edit/' . $eid; ?>">Edit</a> 
                                            </td>
                                            <td class="last text-center" style="cursor: pointer;">
                                                <a class="deleteRecord" href1="<?php echo site_url('/') . 'admin/feetype/delete/' . $eid; ?>">Delete</a> 
                                            </td>
                                    <?php } ?>
                                </tr>
                        <?php
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure to delete this feetype?. </p>
            </div>
...
<div class="modal fade bs-example-modal-sm-all delete-popup-all" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure to delete all the selected feetype(s)?. </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
$(document).ready(function(){
    $("#btnAdd").click(function(){
        ...
        document.location.href = site_url + 'admin/feetype/add';
    });
