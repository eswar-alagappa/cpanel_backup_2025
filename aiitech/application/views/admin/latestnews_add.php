...
<div class="page-title">
    <div class="title_left">
        <h3>
            <?php 
            if ($id==0) {
                echo 'Latest News Add';
            } else {
                echo 'Latest News Edit';
            }
            ?>
        </h3>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_content">
                ...
                action="<?php echo site_url('/')?>admin/latestnews/save" onsubmit='return checkSubmit();'>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            ...
                            <a href="<?php echo site_url('/');?>admin/latestnews" class="btn btn-primary">Back</a>
                        </div>
                    </div>
...
function checkSubmit(){
    ...
    if (roll_num.length < 1) {
        $('.name').text('News is required').show();
        return false;
    }
   return true;
}
