...
<?php
$list = isset($listStaff) ? $listStaff : array();
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
     ...
     <div class="xs tabls">
        <div class="bs-example4" data-example-id="contextual-table">
            <div class="x_content">
                <form method="post" name="form1" id="form1"  action="<?php echo site_url('/') . 'admin/staff/view'; ?>">
                ...
                <table class="table">
                    <thead>
                        <tr class="headings">
                            ...
                            <th class="column-title">Department Handling</th>
                            <th class="column-title">Subject Taken </th>
                            <?php 
                            if ($login_rolename != 'student') { 
                            ?>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="even pointer">
                                    ...
                                    <td class=" "><?php echo $row['department_handling']; ?></td>
                                    <td class=" "><?php echo $row['subject_taken']; ?></td>
                                    <?php 
                                    if ($login_rolename != 'student' ) { 
                                    ?>
                                            <td class=" last text-center">
                                                <a href="<?php echo site_url('/') . 'admin/staff/edit/' . $eid; ?>">Edit</a> 
                                            </td>
                                            <td class="last text-center" style="cursor: pointer;">
                                                <a class="deleteCourse" href1="<?php echo site_url('/') . 'admin/staff/delete/' . $eid; ?>">Delete</a> 
                                            </td>
                                    <?php } ?>
                                </tr>
                        <?php
...
<div class="modal fade bs-example-modal-sm-all delete-popup-all" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure to delete all the selected staff(s)?. </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
$(document).ready(function(){
    $("#btnAdd").click(function(){
        ...
        document.location.href = site_url + 'admin/staff/add';
    });
