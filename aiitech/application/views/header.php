         ...
         <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Admission<span class="caret"></span></a>
          ...
          <?php } ?>
            ...
            <?php if ($PDF_FEE_STRUCTURE == '') { ?>
              <a href="doc/Prospectus-2020-2021.pdf">Fees Structure</a></li>
            <?php } else { ?>
...
<marquee><b>Calendar Year 2025 Admission will start from January 2025 Second week. | Alagappa University – Distance Education Examinations, December 2024 will be commenced from 17.01.2025.</b>
