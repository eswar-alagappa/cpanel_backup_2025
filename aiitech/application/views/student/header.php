...
$IMAGE_DIR = base_url('/') . 'uploaded-images/';
					...
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="menu-list">
							...
							<ul class="sub-menu-list">
								...
								<li><a href="<?php echo site_url('/');?>admin/payment">Fee Receipt</a> </li>
							</ul>
						</li>    
							...
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(<?php echo base_url('/');?>img/ait-logo.gif) no-repeat center"> </span> 
										 <div class="user-name">
