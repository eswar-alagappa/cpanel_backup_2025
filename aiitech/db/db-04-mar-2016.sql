...
INSERT INTO `fee_details` VALUES (2,13,6,3,500.00,'2016-03-24 12:39:04','2016-03-24 12:39:04','superadmin'),(3,13,6,5,200.00,'2016-03-24 12:39:16','2016-03-24 12:39:16','superadmin'),(4,13,6,6,1500.00,'2016-03-24 12:40:29','2016-03-24 12:40:29','superadmin'),(5,12,6,4,2000.00,'2016-04-04 11:00:51','2016-04-04 11:00:51','admin');
...
INSERT INTO `gallery` VALUES (5,'title a','gallery5.png','2016-03-24 08:42:40','2016-04-04 11:48:02','admin','desc a'),(6,'wonderfull','gallery6.png','2016-03-24 08:44:49','2016-04-04 11:48:57','admin','wonderfull wonderfull');
...
INSERT INTO `latest_news` VALUES (4,'news a','2016-03-24 08:01:16','2016-04-04 11:28:20','admin','Ttile a','Desc a'),(5,'news b','2016-03-24 08:02:08','2016-04-04 11:28:33','admin','title b','desc b'),(6,'news c','2016-03-30 08:41:55','2016-04-04 11:28:45','admin','title c','desc c');
...
CREATE TABLE `payment` (
  ...
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(15) DEFAULT NULL,
  `old_semester_id` bigint(20) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payment` VALUES (2,'2016-03-11 00:00:00',18,3,13,7,1000.00,'2016-03-24 11:17:55','2016-04-04 10:57:45','admin',0),(3,'2016-03-24 00:00:00',18,3,12,8,2000.00,'2016-03-24 11:53:42','2016-04-04 10:57:36','admin',0),(4,'2016-04-04 00:00:00',18,6,13,6,200.00,'2016-04-04 10:57:22','2016-04-04 10:57:22','admin',0),(5,'2016-04-04 00:00:00',18,4,13,7,1000.00,'2016-04-04 11:25:41','2016-04-04 11:25:41','admin',6),(6,'2016-04-04 00:00:00',18,4,12,7,2000.00,'2016-04-04 11:26:52','2016-04-04 11:26:52','admin',6);
...
INSERT INTO `slider` VALUES (4,'slider a','description a','slider4.jpg','2016-03-24 10:02:10','2016-04-04 11:44:55','admin'),(5,'title b','desc b','slider5.jpg','2016-04-04 11:37:43','2016-04-04 11:45:07','admin'),(6,'title c','desc c','slider6.jpg','2016-04-04 11:38:01','2016-04-04 11:45:34','admin');
...
CREATE TABLE `student_semester` (
  ...
  `semester_id` bigint(20) DEFAULT '0',
  `course_id` bigint(20) DEFAULT '0',
  `fees_total` float(12,2) DEFAULT '0.00',
  `fees_received` float(12,2) DEFAULT '0.00',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `student_semester` WRITE;
...
CREATE TABLE `users` (
  ...
  `semester_joining_id` int(11) DEFAULT '1',
  PRIMARY KEY (`id`)
...
INSERT INTO `users` VALUES (1,'admin','0192023a7bbd73250516f069df18b500',1,NULL,'2016-03-28 07:30:29',1,'admin','admina','adminb',NULL,'',NULL,'rrishwanth78+admin@gmail.com','',NULL,NULL,NULL,NULL,NULL,'',0,'photo1.gif','','','','','','',NULL,NULL,NULL,NULL,NULL,NULL,'','','',0.00,'',0.0,0,'',NULL,1),(10,'','',2,'2016-03-24 12:50:50','2016-03-24 12:50:50',1,'superadmin','saasd','dasd',NULL,'sasd',NULL,'sdds','',NULL,NULL,NULL,'single',NULL,'',0,'','','','','','','',NULL,NULL,NULL,NULL,NULL,NULL,'','','',0.00,'',0.0,0,'',NULL,1),(11,'','',2,'2016-03-24 12:51:20','2016-03-28 08:01:38',1,'admin','statff a','staff a1','1978-08-15 00:00:00','123',NULL,'rrishwanth78+staffa@gmail.com','',NULL,'1978-08-16 00:00:00',NULL,'single',NULL,'',0,'','','','','','','',NULL,NULL,NULL,NULL,NULL,NULL,'','','',0.00,'',0.0,0,'',NULL,1),(12,'','',2,'2016-03-24 13:16:47','2016-03-28 09:10:19',1,'admin','sa','sa1','1978-08-15 00:00:00','32132132','aaaaaa','rrishwanth78+sa@gmail.com','qqqqqqqqqqqqq','ddddddddddddddd','1978-08-16 00:00:00',3.50,'male','single','',0,'','fa','sp','ppppp','ccccccccc','ssssssssssssss','cou','ssssssssssssssss','ssssssssssssssssssssssss','cococococ','nnnnnnnnnnnnnnnnn',NULL,NULL,'','','',0.00,'',0.0,0,'',NULL,1),(13,'','',2,'2016-03-30 09:29:40','2016-04-04 07:53:01',1,'admin','RISHWANTH','STAFF B','1952-08-15 00:00:00','1234567891','pppppppppppp','rrishwanth78+sb@gmail.com','1232','21321','2016-03-19 00:00:00',232.00,'male','single','',0,'','SPOUSE','','232','2321','21312','1232','21321','123213','2321','21321',NULL,NULL,'','','',0.00,'',0.0,0,'','rrrrrrrrrrrrrrrrrrrrrr',1),(14,'staff','0192023a7bbd73250516f069df18b500',2,NULL,NULL,1,NULL,'Staff','',NULL,'',NULL,'rrishwanth78+staff@gmail.com','',NULL,NULL,NULL,NULL,NULL,'',0,'photo1.gif','','','','','','',NULL,NULL,NULL,NULL,NULL,NULL,'','','',0.00,'',0.0,0,'',NULL,1),(18,'rrishwanth78+1@gmail.com','',3,'2016-04-02 08:27:38','2016-04-04 09:45:00',1,'admin','FN','LN','1952-08-15 00:00:00','1234567890','ADRESS0','rrishwanth78+1@gmail.com','',NULL,NULL,NULL,'male','single','0001',13,'student18.jpg','FSN','','PINCODE','CITY','STATE','COUNTRY',NULL,NULL,NULL,NULL,NULL,NULL,'','tamil','alagappa',18000.00,'semester',3.0,0,'','resiaddres',7);
...
-- Dump completed on 2016-04-04 18:28:05
